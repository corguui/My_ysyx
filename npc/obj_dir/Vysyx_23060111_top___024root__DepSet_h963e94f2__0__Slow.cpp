...
VL_ATTR_COLD void Vysyx_23060111_top___024root___eval_initial(Vysyx_23060111_top___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__ysyx_23060111_top__DOT__funct3 
...
VL_ATTR_COLD void Vysyx_23060111_top___024root___dump_triggers__act(Vysyx_23060111_top___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(1U)) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([changed] pc or [changed] ysyx_23060111_top.funct3 or [changed] ysyx_23060111_top.funct7 or [changed] ysyx_23060111_top.imm or [changed] ysyx_23060111_top.m_rdata or [changed] ysyx_23060111_top.opcode or [changed] ysyx_23060111_top.snpc)\n");
    }
    if (vlSelf->__VactTriggered.at(2U)) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @(posedge clk)\n");
    }
    if (vlSelf->__VactTriggered.at(3U)) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([changed] ysyx_23060111_top.inst)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vysyx_23060111_top___024root___dump_triggers__nba(Vysyx_23060111_top___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(1U)) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([changed] pc or [changed] ysyx_23060111_top.funct3 or [changed] ysyx_23060111_top.funct7 or [changed] ysyx_23060111_top.imm or [changed] ysyx_23060111_top.m_rdata or [changed] ysyx_23060111_top.opcode or [changed] ysyx_23060111_top.snpc)\n");
    }
    if (vlSelf->__VnbaTriggered.at(2U)) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @(posedge clk)\n");
    }
    if (vlSelf->__VnbaTriggered.at(3U)) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([changed] ysyx_23060111_top.inst)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vysyx_23060111_top___024root___ctor_var_reset(Vysyx_23060111_top___024root* vlSelf) {
    ...
    vlSelf->ysyx_23060111_top__DOT__snpc = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vtrigrprev__TOP__ysyx_23060111_top__DOT__snpc = VL_RAND_RESET_I(32);
