...
#endif
                VL_FATAL_MT("build/top.sv", 1214, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT___EXU_io_ar_exu_mem_raddr = VL_RAND_RESET_I(32);
    vlSelf->top__DOT___EXU_io_ar_exu_mem_rmask = VL_RAND_RESET_I(3);
    vlSelf->top__DOT___EXU_io_ar_exu_mem_arvalid = VL_RAND_RESET_I(1);
