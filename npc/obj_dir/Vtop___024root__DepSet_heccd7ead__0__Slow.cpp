...
#endif
                VL_FATAL_MT("build/top.sv", 1150, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT___EXU_io_r_exu_mem_raddr = VL_RAND_RESET_I(32);
    vlSelf->top__DOT___EXU_io_r_exu_mem_arvalid = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__EXU__DOT__lastrdata = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vdly__top__DOT__EXU__DOT__lastrdata = VL_RAND_RESET_I(32);
