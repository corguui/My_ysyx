...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT___Mem_io_r_mem_lsu_rdata = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT___LSU_io_w_lsu_mem_wmask = VL_RAND_RESET_I(3);
    vlSelf->top__DOT___LSU_io_aw_lsu_mem_awaddr = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT__LSU__DOT__io_b_mem_lsu_bready_0 = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__LSU__DOT__io_r_mem_lsu_rready_0 = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__LSU__DOT__io_ar_lsu_mem_arvalid_0 = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__LSU__DOT__io_aw_lsu_mem_awvalid_0 = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__LSU__DOT___GEN_1 = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__LSU__DOT___GEN_2 = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__LSU__DOT__io_w_lsu_mem_wvalid_0 = VL_RAND_RESET_I(1);
