...
extern "C" int vlg_pc_read(int pc, int flag);

VL_INLINE_OPT void Vysyx_23060111_top___024unit____Vdpiimwrap_vlg_pc_read_TOP____024unit(IData/*31:0*/ pc, IData/*31:0*/ flag, IData/*31:0*/ &vlg_pc_read__Vfuncrtn) {
    ...
    vlg_pc_read__Vfuncrtn__Vcvt = vlg_pc_read(pc__Vcvt, flag__Vcvt);
    vlg_pc_read__Vfuncrtn = vlg_pc_read__Vfuncrtn__Vcvt;
}

extern "C" int vlg_pmem_read(int raddr, int flag);

VL_INLINE_OPT void Vysyx_23060111_top___024unit____Vdpiimwrap_vlg_pmem_read_TOP____024unit(IData/*31:0*/ raddr, IData/*31:0*/ flag, IData/*31:0*/ &vlg_pmem_read__Vfuncrtn) {
    ...
    vlg_pmem_read__Vfuncrtn__Vcvt = vlg_pmem_read(raddr__Vcvt, flag__Vcvt);
