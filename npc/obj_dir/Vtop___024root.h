...
class Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ top__DOT__Mem__DOT__delay__DOT__lfsrReg;
        CData/*4:0*/ top__DOT__Mem__DOT__delay__DOT__counter;
        CData/*0:0*/ top__DOT__Mem__DOT__delay__DOT___GEN;
        CData/*1:0*/ top__DOT__Mem__DOT__delay_w__DOT__lfsrReg;
        ...
        CData/*1:0*/ top__DOT__Inst_fetch__DOT__delay__DOT__lfsrReg;
