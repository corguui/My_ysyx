...
void Vysyx_23060111_EXU___024root__trace_chg_sub_0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+10,(vlSelf->out_reg),32);
    bufp->chgIData(oldp+11,(vlSelf->out_reg1),32);
    bufp->chgIData(oldp+12,(vlSelf->reg_out),32);
    bufp->chgIData(oldp+13,(vlSelf->reg_out1),32);
    bufp->chgIData(oldp+14,((vlSelf->inst >> 0x14U)),32);
    bufp->chgBit(oldp+15,((1U & (vlSelf->inst >> 7U))));
    bufp->chgIData(oldp+16,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_rd__DOT__rf[0]),32);
    bufp->chgBit(oldp+17,((1U & (vlSelf->inst >> 0xfU))));
    bufp->chgCData(oldp+18,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->chgCData(oldp+19,((0x7fU & vlSelf->inst)),7);
