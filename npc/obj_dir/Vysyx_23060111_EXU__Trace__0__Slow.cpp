...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_init_sub__TOP__0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+13,"en_reg", false,-1);
    tracep->declBit(c+14,"en_trigger", false,-1);
    tracep->declBus(c+15,"inst", false,-1, 31,0);
    tracep->declBus(c+16,"snpc", false,-1, 31,0);
    tracep->declBus(c+17,"dnpc", false,-1, 31,0);
    tracep->declBus(c+18,"pc", false,-1, 31,0);
    tracep->declBus(c+19,"imm", false,-1, 31,20);
    tracep->declBus(c+20,"rs1", false,-1, 19,15);
    tracep->declBus(c+21,"rd", false,-1, 11,7);
    tracep->declBus(c+22,"out_reg", false,-1, 31,0);
    tracep->declBus(c+23,"reg_out", false,-1, 31,0);
    tracep->declBus(c+24,"reg_out1", false,-1, 31,0);
    ...
    tracep->declBus(c+23,"reg_out", false,-1, 31,0);
    tracep->declBus(c+24,"reg_out1", false,-1, 31,0);
    tracep->declBus(c+25,"imm_32", false,-1, 31,0);
    tracep->pushNamePrefix("reg_rd ");
    tracep->declBus(c+26,"ADDR_WIDTH", false,-1, 31,0);
    tracep->declBus(c+27,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+12,"clk", false,-1);
    ...
    tracep->declBus(c+36,"RESET_VAL", false,-1, 31,0);
    tracep->declBit(c+12,"clk", false,-1);
    tracep->declBit(c+11,"rst", false,-1);
...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_full_sub_0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+13,(vlSelf->en_reg));
    bufp->fullBit(oldp+14,(vlSelf->en_trigger));
    bufp->fullIData(oldp+15,(vlSelf->inst),32);
    bufp->fullIData(oldp+16,(vlSelf->snpc),32);
    bufp->fullIData(oldp+17,(vlSelf->dnpc),32);
    bufp->fullIData(oldp+18,(vlSelf->pc),32);
    bufp->fullSData(oldp+19,(vlSelf->imm),12);
    bufp->fullCData(oldp+20,(vlSelf->rs1),5);
    bufp->fullCData(oldp+21,(vlSelf->rd),5);
    bufp->fullIData(oldp+22,(vlSelf->out_reg),32);
    bufp->fullIData(oldp+23,(vlSelf->reg_out),32);
    bufp->fullIData(oldp+24,(vlSelf->reg_out1),32);
    bufp->fullIData(oldp+25,((vlSelf->inst >> 0x14U)),32);
    bufp->fullIData(oldp+26,(5U),32);
    bufp->fullIData(oldp+27,(0x20U),32);
    bufp->fullBit(oldp+28,(1U));
    bufp->fullIData(oldp+29,(0U),32);
    bufp->fullBit(oldp+30,(0U));
    bufp->fullIData(oldp+31,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[0]),32);
    bufp->fullIData(oldp+32,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[1]),32);
    bufp->fullIData(oldp+33,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[2]),32);
    bufp->fullIData(oldp+34,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[3]),32);
    bufp->fullIData(oldp+35,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[4]),32);
    bufp->fullIData(oldp+36,(0x80000000U),32);
    bufp->fullCData(oldp+37,(0U),5);
    bufp->fullCData(oldp+38,(5U),5);
    bufp->fullIData(oldp+39,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[0]),32);
    bufp->fullIData(oldp+40,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[1]),32);
    bufp->fullIData(oldp+41,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[2]),32);
    bufp->fullIData(oldp+42,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[3]),32);
    bufp->fullIData(oldp+43,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[4]),32);
}
