...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_init_sub__TOP__0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+10,"val", false,-1, 31,0);
    tracep->declBus(c+11,"snpc", false,-1, 31,0);
    tracep->declBus(c+12,"dnpc", false,-1, 31,0);
    tracep->declBus(c+13,"pc", false,-1, 31,0);
    tracep->declBus(c+14,"imm", false,-1, 31,20);
    tracep->declBus(c+15,"rs1", false,-1, 19,15);
    tracep->declBus(c+16,"rd", false,-1, 11,7);
    tracep->declBus(c+17,"out_reg", false,-1, 31,0);
    tracep->declBus(c+18,"out_reg1", false,-1, 31,0);
    tracep->declBus(c+19,"reg_out", false,-1, 31,0);
    tracep->declBus(c+20,"reg_out1", false,-1, 31,0);
    ...
    tracep->declBus(c+19,"reg_out", false,-1, 31,0);
    tracep->declBus(c+20,"reg_out1", false,-1, 31,0);
    tracep->declBus(c+21,"imm_32", false,-1, 31,0);
    ...
    tracep->declBus(c+15,"rs1", false,-1, 19,15);
    tracep->declBus(c+16,"rd", false,-1, 11,7);
    tracep->declBus(c+22,"a", false,-1, 14,12);
    tracep->declBus(c+23,"b", false,-1, 6,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+8,"clk", false,-1);
    tracep->declBus(c+27,"wdata", false,-1, 31,0);
    tracep->declBus(c+28,"waddr", false,-1, 0,0);
    tracep->declBit(c+26,"wen", false,-1);
...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_full_sub_0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+9,(vlSelf->inst),32);
    bufp->fullIData(oldp+10,(vlSelf->val),32);
    bufp->fullIData(oldp+11,(vlSelf->snpc),32);
    bufp->fullIData(oldp+12,(vlSelf->dnpc),32);
    bufp->fullIData(oldp+13,(vlSelf->pc),32);
    bufp->fullSData(oldp+14,(vlSelf->imm),12);
    bufp->fullCData(oldp+15,(vlSelf->rs1),5);
    bufp->fullCData(oldp+16,(vlSelf->rd),5);
    bufp->fullIData(oldp+17,(vlSelf->out_reg),32);
    bufp->fullIData(oldp+18,(vlSelf->out_reg1),32);
    bufp->fullIData(oldp+19,(vlSelf->reg_out),32);
    bufp->fullIData(oldp+20,(vlSelf->reg_out1),32);
    bufp->fullIData(oldp+21,((vlSelf->inst >> 0x14U)),32);
    bufp->fullCData(oldp+22,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->fullCData(oldp+23,((0x7fU & vlSelf->inst)),7);
    ...
    bufp->fullIData(oldp+36,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[0]),32);
}
