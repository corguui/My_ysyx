...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_init_sub__TOP__0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+11,"out_reg", false,-1, 31,0);
    tracep->declBus(c+12,"out_reg1", false,-1, 31,0);
    tracep->declBus(c+13,"reg_out", false,-1, 31,0);
    tracep->declBus(c+14,"reg_out1", false,-1, 31,0);
    tracep->declBus(c+15,"rbb", false,-1, 19,15);
    tracep->declBus(c+16,"rbb1", false,-1, 10,0);
    ...
    tracep->declBus(c+9,"rs1", false,-1, 19,15);
    tracep->declBus(c+10,"rd", false,-1, 11,7);
    tracep->declBus(c+16,"rbb", false,-1, 10,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_full_sub_0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+11,(vlSelf->out_reg),32);
    ...
    bufp->fullCData(oldp+15,(vlSelf->rbb),5);
    bufp->fullSData(oldp+16,(vlSelf->rbb1),11);
