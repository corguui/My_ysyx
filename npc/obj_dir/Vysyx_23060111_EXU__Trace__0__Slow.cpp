...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_init_sub__TOP__0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+14,"snpc", false,-1, 31,0);
    tracep->declBus(c+15,"dnpc", false,-1, 31,0);
    tracep->declBus(c+16,"pc", false,-1, 31,0);
    tracep->declBus(c+17,"imm", false,-1, 31,20);
    tracep->declBus(c+18,"rs1", false,-1, 19,15);
    tracep->declBus(c+19,"rd", false,-1, 11,7);
    tracep->declBus(c+20,"out_reg", false,-1, 31,0);
    tracep->declBus(c+21,"reg_out", false,-1, 31,0);
    tracep->declBus(c+22,"reg_out1", false,-1, 31,0);
    ...
    tracep->declBus(c+21,"reg_out", false,-1, 31,0);
    tracep->declBus(c+22,"reg_out1", false,-1, 31,0);
    tracep->declBus(c+23,"imm_32", false,-1, 31,0);
    ...
    tracep->declBus(c+34,"RESET_VAL", false,-1, 31,0);
    tracep->declBit(c+12,"clk", false,-1);
    tracep->declBit(c+11,"rst", false,-1);
...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_full_sub_0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+14,(vlSelf->snpc),32);
    bufp->fullIData(oldp+15,(vlSelf->dnpc),32);
    bufp->fullIData(oldp+16,(vlSelf->pc),32);
    bufp->fullSData(oldp+17,(vlSelf->imm),12);
    bufp->fullCData(oldp+18,(vlSelf->rs1),5);
    bufp->fullCData(oldp+19,(vlSelf->rd),5);
    bufp->fullIData(oldp+20,(vlSelf->out_reg),32);
    bufp->fullIData(oldp+21,(vlSelf->reg_out),32);
    bufp->fullIData(oldp+22,(vlSelf->reg_out1),32);
    bufp->fullIData(oldp+23,((vlSelf->inst >> 0x14U)),32);
    ...
    bufp->fullIData(oldp+29,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[0]),32);
    bufp->fullIData(oldp+30,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[1]),32);
    bufp->fullIData(oldp+31,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[2]),32);
    bufp->fullIData(oldp+32,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[3]),32);
    bufp->fullIData(oldp+33,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[4]),32);
    bufp->fullIData(oldp+34,(0x80000000U),32);
    bufp->fullCData(oldp+35,(0U),5);
    bufp->fullCData(oldp+36,(5U),5);
    bufp->fullIData(oldp+37,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[0]),32);
    bufp->fullIData(oldp+38,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[1]),32);
    bufp->fullIData(oldp+39,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[2]),32);
    bufp->fullIData(oldp+40,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[3]),32);
    bufp->fullIData(oldp+41,(vlSelf->ysyx_23060111_top__DOT__reg_t0__DOT__rf[4]),32);
}
