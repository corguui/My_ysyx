...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_init_sub__TOP__0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+23,"out_reg", false,-1, 31,0);
    tracep->declBus(c+24,"reg_out", false,-1, 31,0);
    tracep->declBus(c+25,"reg_out1", false,-1, 31,0);
...
VL_ATTR_COLD void Vysyx_23060111_EXU___024root__trace_full_sub_0(Vysyx_23060111_EXU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+22,(vlSelf->out),32);
    bufp->fullIData(oldp+23,(vlSelf->out_reg),32);
    bufp->fullIData(oldp+24,(vlSelf->reg_out),32);
    bufp->fullIData(oldp+25,(vlSelf->reg_out1),32);
