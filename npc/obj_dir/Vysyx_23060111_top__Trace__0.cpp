...
void Vysyx_23060111_top___024root__trace_chg_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgCData(oldp+65,(vlSelf->ysyx_23060111_top__DOT__csr_waddr),2);
        bufp->chgIData(oldp+66,(vlSelf->ysyx_23060111_top__DOT__csr_wdata),32);
        bufp->chgCData(oldp+67,(vlSelf->ysyx_23060111_top__DOT__csr_raddr),2);
        bufp->chgBit(oldp+68,(vlSelf->ysyx_23060111_top__DOT__csr_wen));
        bufp->chgBit(oldp+69,(vlSelf->ysyx_23060111_top__DOT__csr_mepc_wen));
        bufp->chgBit(oldp+70,(vlSelf->ysyx_23060111_top__DOT__csr_mcause_wen));
        bufp->chgBit(oldp+71,(vlSelf->ysyx_23060111_top__DOT__csr_mstatus_wen));
        bufp->chgIData(oldp+72,(vlSelf->ysyx_23060111_top__DOT__csr_rout),32);
        bufp->chgIData(oldp+73,(vlSelf->ysyx_23060111_top__DOT__csr_mcause_wdata),32);
        bufp->chgIData(oldp+74,(vlSelf->ysyx_23060111_top__DOT__csr_mepc_wdata),32);
        bufp->chgIData(oldp+75,(vlSelf->ysyx_23060111_top__DOT__csr_mstatus_wdata),32);
        bufp->chgIData(oldp+76,(vlSelf->ysyx_23060111_top__DOT__m_waddr),32);
        bufp->chgIData(oldp+77,(vlSelf->ysyx_23060111_top__DOT__m_wdata),32);
        bufp->chgIData(oldp+78,(vlSelf->ysyx_23060111_top__DOT__m_wmask),32);
        bufp->chgIData(oldp+79,(vlSelf->ysyx_23060111_top__DOT__m_rdata),32);
        bufp->chgIData(oldp+80,(vlSelf->ysyx_23060111_top__DOT__m_raddr),32);
        bufp->chgIData(oldp+81,(vlSelf->ysyx_23060111_top__DOT__m_rmask),32);
        bufp->chgBit(oldp+82,(vlSelf->ysyx_23060111_top__DOT__m_wen));
        bufp->chgBit(oldp+83,(vlSelf->ysyx_23060111_top__DOT__m_ren));
        bufp->chgCData(oldp+84,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__csr_flag),2);
        bufp->chgBit(oldp+85,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__ALU_init__DOT__cond_beq));
        bufp->chgBit(oldp+86,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__ALU_init__DOT__cond_bge));
        bufp->chgBit(oldp+87,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__ALU_init__DOT__cond_bgeu));
        bufp->chgQData(oldp+88,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellout__typeMux____pinNumber1),33);
        bufp->chgWData(oldp+90,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellinp__typeMux____pinNumber4),400);
        bufp->chgQData(oldp+103,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[0]),40);
        bufp->chgQData(oldp+105,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[1]),40);
        bufp->chgQData(oldp+107,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[2]),40);
        bufp->chgQData(oldp+109,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[3]),40);
        bufp->chgQData(oldp+111,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[4]),40);
        bufp->chgQData(oldp+113,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[5]),40);
        bufp->chgQData(oldp+115,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[6]),40);
        bufp->chgQData(oldp+117,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[7]),40);
        bufp->chgQData(oldp+119,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[8]),40);
        bufp->chgQData(oldp+121,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[9]),40);
        bufp->chgQData(oldp+123,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[0]),33);
        bufp->chgQData(oldp+125,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[1]),33);
        bufp->chgQData(oldp+127,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[2]),33);
        bufp->chgQData(oldp+129,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[3]),33);
        bufp->chgQData(oldp+131,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[4]),33);
        bufp->chgQData(oldp+133,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[5]),33);
        bufp->chgQData(oldp+135,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[6]),33);
        bufp->chgQData(oldp+137,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[7]),33);
        bufp->chgQData(oldp+139,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[8]),33);
        bufp->chgQData(oldp+141,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[9]),33);
        bufp->chgQData(oldp+143,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__lut_out),33);
        bufp->chgBit(oldp+145,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__hit));
    }
    ...
    bufp->chgBit(oldp+151,(vlSelf->ysyx_23060111_top__DOT__wen));
}
