...
void Vysyx_23060111_top___024root__trace_chg_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+91,((0x1fU & (vlSelf->inst 
                                      >> 7U))),5);
    bufp->chgCData(oldp+92,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->chgCData(oldp+93,((0x1fU & (vlSelf->inst 
                                      >> 0xfU))),5);
    bufp->chgCData(oldp+94,((0x1fU & (vlSelf->inst 
                                      >> 0x14U))),5);
    bufp->chgCData(oldp+95,((vlSelf->inst >> 0x19U)),7);
    bufp->chgIData(oldp+96,(vlSelf->ysyx_23060111_top__DOT__rout),32);
    bufp->chgIData(oldp+97,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__dnpc),32);
    bufp->chgIData(oldp+98,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__data),32);
}
