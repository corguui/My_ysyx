...
void Vysyx_23060111_top___024root__trace_chg_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+12,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                          >> 7U))),5);
        bufp->chgCData(oldp+13,(vlSelf->ysyx_23060111_top__DOT__funct3),3);
        ...
        bufp->chgCData(oldp+15,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                          >> 0x14U))),5);
        bufp->chgCData(oldp+16,(vlSelf->ysyx_23060111_top__DOT__funct7),7);
        bufp->chgIData(oldp+17,(vlSelf->ysyx_23060111_top__DOT__imm),32);
    ...
    bufp->chgIData(oldp+124,(vlSelf->ysyx_23060111_top__DOT__snpc),32);
