...
void Vysyx_23060111_top___024root__trace_chg_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgIData(oldp+71,(vlSelf->ysyx_23060111_top__DOT__dnpc),32);
        bufp->chgIData(oldp+72,(vlSelf->ysyx_23060111_top__DOT__wdata),32);
        bufp->chgBit(oldp+73,(vlSelf->ysyx_23060111_top__DOT__wen));
    }
    ...
    bufp->chgIData(oldp+85,(vlSelf->ysyx_23060111_top__DOT__rout),32);
}
