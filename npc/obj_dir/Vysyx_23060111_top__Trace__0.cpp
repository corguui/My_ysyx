...
void Vysyx_23060111_top___024root__trace_chg_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+85,(vlSelf->ysyx_23060111_top__DOT__m_raddr),32);
    ...
    bufp->chgIData(oldp+125,(((IData)(4U) + vlSelf->pc)),32);
    bufp->chgIData(oldp+126,(vlSelf->ysyx_23060111_top__DOT__wdata),32);
