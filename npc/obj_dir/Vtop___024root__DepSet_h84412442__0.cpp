...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->top__DOT__LSU__DOT__pc_reg = 0U;
    } else {
        ...
        vlSelf->top__DOT__LSU__DOT__pc_reg = vlSelf->top__DOT__LSU__DOT__wbu_data_pc;
    }
    ...
    } else if (vlSelf->top__DOT__LSU__DOT__io_ar_exu_mem_arvalid_0) {
        vlSelf->top__DOT__Mem__DOT__rresp_reg = (((IData)(vlSelf->top__DOT__LSU__DOT__io_ar_exu_mem_arvalid_0) 
