...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->top__DOT__IDU__DOT__in_data_inst = vlSelf->top__DOT__IFU__DOT__lastinst;
    if (vlSelf->reset) {
...
#endif
                    VL_FATAL_MT("build/top.sv", 1069, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("build/top.sv", 1069, "", "NBA region did not converge.");
            }
