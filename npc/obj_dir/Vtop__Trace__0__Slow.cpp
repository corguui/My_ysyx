...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+114,"io_out2ifu_valid", false,-1);
    ...
    tracep->declBus(c+117,"io_reg_data_raddr_1", false,-1, 4,0);
    tracep->declBus(c+118,"io_reg_data_rdata_1", false,-1, 31,0);
    tracep->declBus(c+119,"io_reg_data_raddr_2", false,-1, 4,0);
    tracep->declBus(c+120,"io_reg_data_rdata_2", false,-1, 31,0);
    tracep->declBus(c+121,"io_reg_data_csr_raddr", false,-1, 1,0);
    tracep->declBus(c+135,"io_reg_data_csr_rdata", false,-1, 31,0);
    ...
    tracep->declBus(c+122,"csr_imm", false,-1, 31,0);
    tracep->declBus(c+123,"casez_tmp", false,-1, 4,0);
    tracep->declBus(c+124,"casez_tmp_0", false,-1, 4,0);
    ...
    tracep->declBit(c+130,"clock", false,-1);
    tracep->declBit(c+131,"reset", false,-1);
    tracep->declBit(c+115,"io_out_valid", false,-1);
    tracep->declBus(c+134,"io_out_bits_snpc", false,-1, 31,0);
    tracep->declBus(c+132,"io_out_bits_pc", false,-1, 31,0);
    tracep->declBus(c+116,"io_out_bits_inst", false,-1, 31,0);
    tracep->declBit(c+114,"io_exu2in_valid", false,-1);
    tracep->declBus(c+18,"io_exu2in_bits_dnpc", false,-1, 31,0);
    tracep->declBus(c+136,"io_axi_ar_pc", false,-1, 31,0);
    tracep->declBit(c+125,"io_axi_ar_arvalid", false,-1);
    tracep->declBus(c+126,"io_axi_r_inst", false,-1, 31,0);
    tracep->declBit(c+127,"io_axi_r_rvalid", false,-1);
    tracep->declBus(c+132,"io_out_bits_pc_0", false,-1, 31,0);
    tracep->declBit(c+128,"m2EXUstate", false,-1);
    tracep->declBit(c+65,"exu2in_reg", false,-1);
    tracep->declBit(c+115,"rready_reg", false,-1);
    tracep->declBus(c+66,"ardata_reg", false,-1, 31,0);
    tracep->declBus(c+116,"inst_reg", false,-1, 31,0);
    tracep->declBit(c+125,"arvalid_reg", false,-1);
    tracep->declBus(c+67,"indata_dnpc", false,-1, 31,0);
    tracep->declBus(c+68,"io_out_bits_pc_REG", false,-1, 31,0);
    ...
    tracep->declBit(c+125,"pc_en", false,-1);
    ...
    tracep->declBus(c+71,"rresp_reg", false,-1, 1,0);
    ...
    tracep->declBit(c+79,"m_wready", false,-1);
    tracep->popNamePrefix(2);
    ...
    tracep->declBit(c+40,"io_csr_wen_2", false,-1);
    tracep->declBus(c+39,"io_csr_wdata_2", false,-1, 31,0);
    tracep->declBus(c+117,"io_reg_read_raddr_1", false,-1, 4,0);
    tracep->declBus(c+118,"io_reg_read_rdata_1", false,-1, 31,0);
    tracep->declBus(c+119,"io_reg_read_raddr_2", false,-1, 4,0);
    tracep->declBus(c+120,"io_reg_read_rdata_2", false,-1, 31,0);
    tracep->declBus(c+121,"io_reg_read_csr_raddr", false,-1, 1,0);
    tracep->declBus(c+135,"io_reg_read_csr_rdata", false,-1, 31,0);
    ...
    tracep->declBus(c+36,"io_csr_waddr_1", false,-1, 1,0);
    tracep->declBus(c+37,"io_csr_wdata_1", false,-1, 31,0);
    tracep->declBus(c+80,"csr_0", false,-1, 31,0);
    tracep->declBus(c+81,"csr_1", false,-1, 31,0);
    tracep->declBus(c+63,"csr_2", false,-1, 31,0);
    tracep->declBus(c+82,"csr_3", false,-1, 31,0);
    tracep->declBus(c+83,"reg_0", false,-1, 31,0);
    tracep->declBus(c+84,"reg_1", false,-1, 31,0);
    tracep->declBus(c+85,"reg_2", false,-1, 31,0);
    tracep->declBus(c+86,"reg_3", false,-1, 31,0);
    tracep->declBus(c+87,"reg_4", false,-1, 31,0);
    tracep->declBus(c+88,"reg_5", false,-1, 31,0);
    tracep->declBus(c+89,"reg_6", false,-1, 31,0);
    tracep->declBus(c+90,"reg_7", false,-1, 31,0);
    tracep->declBus(c+91,"reg_8", false,-1, 31,0);
    tracep->declBus(c+92,"reg_9", false,-1, 31,0);
    tracep->declBus(c+93,"reg_10", false,-1, 31,0);
    tracep->declBus(c+94,"reg_11", false,-1, 31,0);
    tracep->declBus(c+95,"reg_12", false,-1, 31,0);
    tracep->declBus(c+96,"reg_13", false,-1, 31,0);
    tracep->declBus(c+97,"reg_14", false,-1, 31,0);
    tracep->declBus(c+62,"reg_15", false,-1, 31,0);
    tracep->declBus(c+98,"reg_16", false,-1, 31,0);
    tracep->declBus(c+99,"reg_17", false,-1, 31,0);
    tracep->declBus(c+100,"reg_18", false,-1, 31,0);
    tracep->declBus(c+101,"reg_19", false,-1, 31,0);
    tracep->declBus(c+102,"reg_20", false,-1, 31,0);
    tracep->declBus(c+103,"reg_21", false,-1, 31,0);
    tracep->declBus(c+104,"reg_22", false,-1, 31,0);
    tracep->declBus(c+105,"reg_23", false,-1, 31,0);
    tracep->declBus(c+106,"reg_24", false,-1, 31,0);
    tracep->declBus(c+107,"reg_25", false,-1, 31,0);
    tracep->declBus(c+108,"reg_26", false,-1, 31,0);
    tracep->declBus(c+109,"reg_27", false,-1, 31,0);
    tracep->declBus(c+110,"reg_28", false,-1, 31,0);
    tracep->declBus(c+111,"reg_29", false,-1, 31,0);
    tracep->declBus(c+112,"reg_30", false,-1, 31,0);
    tracep->declBus(c+113,"reg_31", false,-1, 31,0);
    tracep->declBus(c+118,"casez_tmp", false,-1, 31,0);
    tracep->declBus(c+120,"casez_tmp_0", false,-1, 31,0);
    tracep->declBus(c+135,"casez_tmp_1", false,-1, 31,0);
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+67,(vlSelf->top__DOT__IFU__DOT__indata_dnpc),32);
    bufp->fullIData(oldp+68,(vlSelf->top__DOT__IFU__DOT__io_out_bits_pc_REG),32);
    bufp->fullIData(oldp+69,(vlSelf->top__DOT__Inst_fetch__DOT___vlg_pc_read_inst),32);
    bufp->fullIData(oldp+70,(vlSelf->top__DOT__Mem__DOT__rdata_reg),32);
    bufp->fullCData(oldp+71,(vlSelf->top__DOT__Mem__DOT__rresp_reg),2);
    ...
    bufp->fullIData(oldp+75,(((IData)(vlSelf->top__DOT__EXU__DOT__mem_wen_reg)
                               ...
                               : 0U)),32);
    bufp->fullIData(oldp+76,(vlSelf->top__DOT__Mem__DOT___GEN),32);
    bufp->fullIData(oldp+77,(vlSelf->top__DOT__Mem__DOT___GEN_0),32);
    bufp->fullIData(oldp+78,(vlSelf->top__DOT__Mem__DOT___m_m_rdata),32);
    bufp->fullBit(oldp+79,(vlSelf->top__DOT__Mem__DOT__m__DOT__m_wready));
    bufp->fullIData(oldp+80,(vlSelf->top__DOT__Reg__DOT__csr_0),32);
    bufp->fullIData(oldp+81,(vlSelf->top__DOT__Reg__DOT__csr_1),32);
    bufp->fullIData(oldp+82,(vlSelf->top__DOT__Reg__DOT__csr_3),32);
    bufp->fullIData(oldp+83,(vlSelf->top__DOT__Reg__DOT__reg_0),32);
    bufp->fullIData(oldp+84,(vlSelf->top__DOT__Reg__DOT__reg_1),32);
    bufp->fullIData(oldp+85,(vlSelf->top__DOT__Reg__DOT__reg_2),32);
    bufp->fullIData(oldp+86,(vlSelf->top__DOT__Reg__DOT__reg_3),32);
    bufp->fullIData(oldp+87,(vlSelf->top__DOT__Reg__DOT__reg_4),32);
    bufp->fullIData(oldp+88,(vlSelf->top__DOT__Reg__DOT__reg_5),32);
    bufp->fullIData(oldp+89,(vlSelf->top__DOT__Reg__DOT__reg_6),32);
    bufp->fullIData(oldp+90,(vlSelf->top__DOT__Reg__DOT__reg_7),32);
    bufp->fullIData(oldp+91,(vlSelf->top__DOT__Reg__DOT__reg_8),32);
    bufp->fullIData(oldp+92,(vlSelf->top__DOT__Reg__DOT__reg_9),32);
    bufp->fullIData(oldp+93,(vlSelf->top__DOT__Reg__DOT__reg_10),32);
    bufp->fullIData(oldp+94,(vlSelf->top__DOT__Reg__DOT__reg_11),32);
    bufp->fullIData(oldp+95,(vlSelf->top__DOT__Reg__DOT__reg_12),32);
    bufp->fullIData(oldp+96,(vlSelf->top__DOT__Reg__DOT__reg_13),32);
    bufp->fullIData(oldp+97,(vlSelf->top__DOT__Reg__DOT__reg_14),32);
    bufp->fullIData(oldp+98,(vlSelf->top__DOT__Reg__DOT__reg_16),32);
    bufp->fullIData(oldp+99,(vlSelf->top__DOT__Reg__DOT__reg_17),32);
    bufp->fullIData(oldp+100,(vlSelf->top__DOT__Reg__DOT__reg_18),32);
    bufp->fullIData(oldp+101,(vlSelf->top__DOT__Reg__DOT__reg_19),32);
    bufp->fullIData(oldp+102,(vlSelf->top__DOT__Reg__DOT__reg_20),32);
    bufp->fullIData(oldp+103,(vlSelf->top__DOT__Reg__DOT__reg_21),32);
    bufp->fullIData(oldp+104,(vlSelf->top__DOT__Reg__DOT__reg_22),32);
    bufp->fullIData(oldp+105,(vlSelf->top__DOT__Reg__DOT__reg_23),32);
    bufp->fullIData(oldp+106,(vlSelf->top__DOT__Reg__DOT__reg_24),32);
    bufp->fullIData(oldp+107,(vlSelf->top__DOT__Reg__DOT__reg_25),32);
    bufp->fullIData(oldp+108,(vlSelf->top__DOT__Reg__DOT__reg_26),32);
    bufp->fullIData(oldp+109,(vlSelf->top__DOT__Reg__DOT__reg_27),32);
    bufp->fullIData(oldp+110,(vlSelf->top__DOT__Reg__DOT__reg_28),32);
    bufp->fullIData(oldp+111,(vlSelf->top__DOT__Reg__DOT__reg_29),32);
    bufp->fullIData(oldp+112,(vlSelf->top__DOT__Reg__DOT__reg_30),32);
    bufp->fullIData(oldp+113,(vlSelf->top__DOT__Reg__DOT__reg_31),32);
    bufp->fullBit(oldp+114,(vlSelf->top__DOT___EXU_io_out2ifu_valid));
    bufp->fullBit(oldp+115,(vlSelf->top__DOT__IFU__DOT__rready_reg));
    bufp->fullIData(oldp+116,(vlSelf->top__DOT__IFU__DOT__inst_reg),32);
    bufp->fullCData(oldp+117,((0x1fU & (vlSelf->top__DOT__IFU__DOT__inst_reg 
                                        >> 0xfU))),5);
    bufp->fullIData(oldp+118,(vlSelf->top__DOT__Reg__DOT__casez_tmp),32);
    bufp->fullCData(oldp+119,((0x1fU & (vlSelf->top__DOT__IFU__DOT__inst_reg 
                                        >> 0x14U))),5);
    bufp->fullIData(oldp+120,(vlSelf->top__DOT__Reg__DOT__casez_tmp_0),32);
    bufp->fullCData(oldp+121,(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr),2);
    bufp->fullIData(oldp+122,(vlSelf->top__DOT__IDU__DOT__csr_imm),32);
    bufp->fullCData(oldp+123,(vlSelf->top__DOT__IDU__DOT__casez_tmp),5);
    bufp->fullCData(oldp+124,(vlSelf->top__DOT__IDU__DOT__casez_tmp_0),5);
    bufp->fullBit(oldp+125,(vlSelf->top__DOT__IFU__DOT__arvalid_reg));
    bufp->fullIData(oldp+126,(((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg)
                                ? vlSelf->top__DOT__Inst_fetch__DOT__rdata_reg
                                : 0U)),32);
    bufp->fullBit(oldp+127,(vlSelf->top__DOT__Inst_fetch__DOT__rvalid_reg));
    bufp->fullBit(oldp+128,(vlSelf->top__DOT__IFU__DOT__m2EXUstate));
    bufp->fullIData(oldp+129,(vlSelf->top__DOT__Inst_fetch__DOT__rdata_reg),32);
    ...
    bufp->fullIData(oldp+134,(((IData)(4U) + vlSelf->io_pc)),32);
    bufp->fullIData(oldp+135,(((0U == (IData)(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr))
