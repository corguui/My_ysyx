...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+77,"io_idu2in_bits_inst_type", false,-1, 3,0);
    ...
    tracep->declBus(c+77,"io_out2exu_bits_inst_type", false,-1, 3,0);
    ...
    tracep->declBus(c+74,"io_reg_data_csr_rdata", false,-1, 31,0);
    tracep->declBus(c+22,"io_reg_data_csr_a5", false,-1, 31,0);
    tracep->declBus(c+23,"io_reg_data_mstatus", false,-1, 31,0);
    tracep->declBit(c+120,"io_inv_flag", false,-1);
    ...
    tracep->declBus(c+77,"exu_data_inst_type", false,-1, 3,0);
    tracep->declBus(c+24,"lastaluop", false,-1, 4,0);
    tracep->declBus(c+25,"lastimm", false,-1, 31,0);
    ...
    tracep->declBus(c+86,"io_aw_exu_mem_awaddr", false,-1, 31,0);
    tracep->declBit(c+85,"io_aw_exu_mem_awvalid", false,-1);
    tracep->declBus(c+28,"lastawaddr", false,-1, 31,0);
    tracep->declBus(c+29,"lastwdata", false,-1, 31,0);
    tracep->declBus(c+30,"rdata_reg", false,-1, 31,0);
    tracep->declBit(c+82,"rvalid_reg", false,-1);
    tracep->declBus(c+31,"rresp_reg", false,-1, 1,0);
    ...
    tracep->declBit(c+32,"m_wready", false,-1);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+74,"io_reg_read_csr_rdata", false,-1, 31,0);
    tracep->declBus(c+22,"io_reg_read_csr_a5", false,-1, 31,0);
    tracep->declBus(c+23,"io_reg_read_mstatus", false,-1, 31,0);
    ...
    tracep->declBus(c+89,"io_csr_waddr_1", false,-1, 1,0);
    tracep->declBus(c+90,"io_csr_wdata_1", false,-1, 31,0);
    tracep->declBus(c+33,"csr_0", false,-1, 31,0);
    tracep->declBus(c+34,"csr_1", false,-1, 31,0);
    tracep->declBus(c+23,"csr_2", false,-1, 31,0);
    tracep->declBus(c+35,"csr_3", false,-1, 31,0);
    tracep->declBus(c+36,"reg_0", false,-1, 31,0);
    tracep->declBus(c+37,"reg_1", false,-1, 31,0);
    tracep->declBus(c+38,"reg_2", false,-1, 31,0);
    tracep->declBus(c+39,"reg_3", false,-1, 31,0);
    tracep->declBus(c+40,"reg_4", false,-1, 31,0);
    tracep->declBus(c+41,"reg_5", false,-1, 31,0);
    tracep->declBus(c+42,"reg_6", false,-1, 31,0);
    tracep->declBus(c+43,"reg_7", false,-1, 31,0);
    tracep->declBus(c+44,"reg_8", false,-1, 31,0);
    tracep->declBus(c+45,"reg_9", false,-1, 31,0);
    tracep->declBus(c+46,"reg_10", false,-1, 31,0);
    tracep->declBus(c+47,"reg_11", false,-1, 31,0);
    tracep->declBus(c+48,"reg_12", false,-1, 31,0);
    tracep->declBus(c+49,"reg_13", false,-1, 31,0);
    tracep->declBus(c+50,"reg_14", false,-1, 31,0);
    tracep->declBus(c+22,"reg_15", false,-1, 31,0);
    tracep->declBus(c+51,"reg_16", false,-1, 31,0);
    tracep->declBus(c+52,"reg_17", false,-1, 31,0);
    tracep->declBus(c+53,"reg_18", false,-1, 31,0);
    tracep->declBus(c+54,"reg_19", false,-1, 31,0);
    tracep->declBus(c+55,"reg_20", false,-1, 31,0);
    tracep->declBus(c+56,"reg_21", false,-1, 31,0);
    tracep->declBus(c+57,"reg_22", false,-1, 31,0);
    tracep->declBus(c+58,"reg_23", false,-1, 31,0);
    tracep->declBus(c+59,"reg_24", false,-1, 31,0);
    tracep->declBus(c+60,"reg_25", false,-1, 31,0);
    tracep->declBus(c+61,"reg_26", false,-1, 31,0);
    tracep->declBus(c+62,"reg_27", false,-1, 31,0);
    tracep->declBus(c+63,"reg_28", false,-1, 31,0);
    tracep->declBus(c+64,"reg_29", false,-1, 31,0);
    tracep->declBus(c+65,"reg_30", false,-1, 31,0);
    tracep->declBus(c+66,"reg_31", false,-1, 31,0);
    tracep->declBus(c+101,"casez_tmp", false,-1, 31,0);
    tracep->declBus(c+103,"casez_tmp_0", false,-1, 31,0);
    tracep->declBus(c+74,"casez_tmp_1", false,-1, 31,0);
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+23,(vlSelf->top__DOT__Reg__DOT__csr_2),32);
    bufp->fullCData(oldp+24,(vlSelf->top__DOT__IDU__DOT__lastaluop),5);
    bufp->fullIData(oldp+25,(vlSelf->top__DOT__IDU__DOT__lastimm),32);
    bufp->fullBit(oldp+26,(vlSelf->top__DOT__IDU__DOT__state));
    bufp->fullIData(oldp+27,(vlSelf->top__DOT__IFU__DOT___vlg_pc_read_inst),32);
    bufp->fullIData(oldp+28,(vlSelf->top__DOT__Mem__DOT__lastawaddr),32);
    bufp->fullIData(oldp+29,(vlSelf->top__DOT__Mem__DOT__lastwdata),32);
    bufp->fullIData(oldp+30,(vlSelf->top__DOT__Mem__DOT__rdata_reg),32);
    bufp->fullCData(oldp+31,(vlSelf->top__DOT__Mem__DOT__rresp_reg),2);
    bufp->fullBit(oldp+32,(vlSelf->top__DOT__Mem__DOT__m__DOT__m_wready));
    bufp->fullIData(oldp+33,(vlSelf->top__DOT__Reg__DOT__csr_0),32);
    bufp->fullIData(oldp+34,(vlSelf->top__DOT__Reg__DOT__csr_1),32);
    bufp->fullIData(oldp+35,(vlSelf->top__DOT__Reg__DOT__csr_3),32);
    bufp->fullIData(oldp+36,(vlSelf->top__DOT__Reg__DOT__reg_0),32);
    bufp->fullIData(oldp+37,(vlSelf->top__DOT__Reg__DOT__reg_1),32);
    bufp->fullIData(oldp+38,(vlSelf->top__DOT__Reg__DOT__reg_2),32);
    bufp->fullIData(oldp+39,(vlSelf->top__DOT__Reg__DOT__reg_3),32);
    bufp->fullIData(oldp+40,(vlSelf->top__DOT__Reg__DOT__reg_4),32);
    bufp->fullIData(oldp+41,(vlSelf->top__DOT__Reg__DOT__reg_5),32);
    bufp->fullIData(oldp+42,(vlSelf->top__DOT__Reg__DOT__reg_6),32);
    bufp->fullIData(oldp+43,(vlSelf->top__DOT__Reg__DOT__reg_7),32);
    bufp->fullIData(oldp+44,(vlSelf->top__DOT__Reg__DOT__reg_8),32);
    bufp->fullIData(oldp+45,(vlSelf->top__DOT__Reg__DOT__reg_9),32);
    bufp->fullIData(oldp+46,(vlSelf->top__DOT__Reg__DOT__reg_10),32);
    bufp->fullIData(oldp+47,(vlSelf->top__DOT__Reg__DOT__reg_11),32);
    bufp->fullIData(oldp+48,(vlSelf->top__DOT__Reg__DOT__reg_12),32);
    bufp->fullIData(oldp+49,(vlSelf->top__DOT__Reg__DOT__reg_13),32);
    bufp->fullIData(oldp+50,(vlSelf->top__DOT__Reg__DOT__reg_14),32);
    bufp->fullIData(oldp+51,(vlSelf->top__DOT__Reg__DOT__reg_16),32);
    bufp->fullIData(oldp+52,(vlSelf->top__DOT__Reg__DOT__reg_17),32);
    bufp->fullIData(oldp+53,(vlSelf->top__DOT__Reg__DOT__reg_18),32);
    bufp->fullIData(oldp+54,(vlSelf->top__DOT__Reg__DOT__reg_19),32);
    bufp->fullIData(oldp+55,(vlSelf->top__DOT__Reg__DOT__reg_20),32);
    bufp->fullIData(oldp+56,(vlSelf->top__DOT__Reg__DOT__reg_21),32);
    bufp->fullIData(oldp+57,(vlSelf->top__DOT__Reg__DOT__reg_22),32);
    bufp->fullIData(oldp+58,(vlSelf->top__DOT__Reg__DOT__reg_23),32);
    bufp->fullIData(oldp+59,(vlSelf->top__DOT__Reg__DOT__reg_24),32);
    bufp->fullIData(oldp+60,(vlSelf->top__DOT__Reg__DOT__reg_25),32);
    bufp->fullIData(oldp+61,(vlSelf->top__DOT__Reg__DOT__reg_26),32);
    bufp->fullIData(oldp+62,(vlSelf->top__DOT__Reg__DOT__reg_27),32);
    bufp->fullIData(oldp+63,(vlSelf->top__DOT__Reg__DOT__reg_28),32);
    bufp->fullIData(oldp+64,(vlSelf->top__DOT__Reg__DOT__reg_29),32);
    bufp->fullIData(oldp+65,(vlSelf->top__DOT__Reg__DOT__reg_30),32);
    bufp->fullIData(oldp+66,(vlSelf->top__DOT__Reg__DOT__reg_31),32);
    bufp->fullIData(oldp+67,(((IData)(vlSelf->top__DOT__EXU__DOT___GEN_5)
                               ? 0U : vlSelf->top__DOT__EXU__DOT__mem_raddr_reg)),32);
    bufp->fullCData(oldp+68,(((IData)(vlSelf->top__DOT__EXU__DOT___GEN_5)
    ...
    bufp->fullBit(oldp+73,(((IData)(vlSelf->top__DOT__EXU__DOT__m2IDUstate) 
                            & ((~ (IData)(vlSelf->top__DOT__EXU__DOT___GEN_24)) 
                               & (0xcU == (IData)(vlSelf->top__DOT__IDU__DOT__exu_data_inst_type))))));
    bufp->fullIData(oldp+74,(((0U == (IData)(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr))
    ...
    bufp->fullIData(oldp+75,((((IData)(vlSelf->top__DOT___EXU_io_w_exu_mem_wvalid) 
                               & (vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr 
                                  != vlSelf->top__DOT__Mem__DOT__lastawaddr))
                               ? vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr
                               : 0U)),32);
    bufp->fullIData(oldp+76,(((IData)(vlSelf->top__DOT__Mem__DOT___GEN_2)
                               ? ((IData)(vlSelf->top__DOT__EXU__DOT___GEN_8)
                                   ? 0U : (7U & vlSelf->top__DOT__IDU__DOT__exu_data_m_wmask))
                               : 0U)),32);
    bufp->fullCData(oldp+77,(vlSelf->top__DOT__IDU__DOT__exu_data_inst_type),4);
    bufp->fullBit(oldp+78,(((3U == (IData)(vlSelf->top__DOT__IDU__DOT__exu_data_inst_type))
