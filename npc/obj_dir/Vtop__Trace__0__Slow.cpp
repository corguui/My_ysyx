...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBit(c+194,"clock", false,-1);
    tracep->declBit(c+195,"reset", false,-1);
    tracep->declBus(c+196,"io_pc", false,-1, 31,0);
    tracep->declBit(c+197,"io_inv_flag", false,-1);
    ...
    tracep->declBit(c+166,"io_out2ifu_valid", false,-1);
    tracep->declBus(c+167,"io_out2ifu_bits_dnpc", false,-1, 31,0);
    ...
    tracep->declBus(c+167,"ifu_outdata_dnpc", false,-1, 31,0);
    ...
    tracep->declBus(c+204,"dataReg", false,-1, 31,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("IDU ");
    tracep->declBit(c+194,"clock", false,-1);
    tracep->declBit(c+195,"reset", false,-1);
    tracep->declBit(c+168,"io_ifu2in_valid", false,-1);
    tracep->declBus(c+198,"io_ifu2in_bits_snpc", false,-1, 31,0);
    tracep->declBus(c+196,"io_ifu2in_bits_pc", false,-1, 31,0);
    tracep->declBus(c+169,"io_ifu2in_bits_inst", false,-1, 31,0);
    ...
    tracep->declBus(c+170,"io_reg_data_raddr_1", false,-1, 4,0);
    tracep->declBus(c+171,"io_reg_data_rdata_1", false,-1, 31,0);
    tracep->declBus(c+172,"io_reg_data_raddr_2", false,-1, 4,0);
    tracep->declBus(c+173,"io_reg_data_rdata_2", false,-1, 31,0);
    tracep->declBus(c+174,"io_reg_data_csr_raddr", false,-1, 1,0);
    tracep->declBus(c+199,"io_reg_data_csr_rdata", false,-1, 31,0);
    tracep->declBus(c+94,"io_reg_data_csr_a5", false,-1, 31,0);
    tracep->declBus(c+95,"io_reg_data_mstatus", false,-1, 31,0);
    tracep->declBit(c+197,"io_inv_flag", false,-1);
    ...
    tracep->declBit(c+96,"state", false,-1);
    tracep->declBit(c+1,"state_reg", false,-1);
    tracep->declBus(c+175,"csr_imm", false,-1, 31,0);
    tracep->declBus(c+176,"casez_tmp", false,-1, 4,0);
    tracep->declBus(c+177,"casez_tmp_0", false,-1, 4,0);
    ...
    tracep->declBus(c+198,"io_out_bits_snpc", false,-1, 31,0);
    tracep->declBus(c+196,"io_out_bits_pc", false,-1, 31,0);
    tracep->declBus(c+169,"io_out_bits_inst", false,-1, 31,0);
    tracep->declBit(c+166,"io_exu2in_valid", false,-1);
    tracep->declBus(c+167,"io_exu2in_bits_dnpc", false,-1, 31,0);
    tracep->declBus(c+178,"io_axi_ar_pc", false,-1, 31,0);
    tracep->declBit(c+179,"io_axi_ar_arvalid", false,-1);
    tracep->declBus(c+180,"io_axi_r_inst", false,-1, 31,0);
    tracep->declBit(c+181,"io_axi_r_rvalid", false,-1);
    tracep->declBit(c+168,"io_axi_r_rready", false,-1);
    tracep->declBus(c+196,"io_out_bits_pc_0", false,-1, 31,0);
    tracep->declBit(c+182,"m2EXUstate", false,-1);
    tracep->declBit(c+183,"exu2in_reg", false,-1);
    tracep->declBus(c+184,"indata_dnpc", false,-1, 31,0);
    tracep->declBit(c+168,"rready_reg", false,-1);
    tracep->declBus(c+185,"ardata_reg", false,-1, 31,0);
    tracep->declBus(c+169,"inst_reg", false,-1, 31,0);
    tracep->declBit(c+179,"arvalid_reg", false,-1);
    tracep->declBus(c+186,"io_out_bits_pc_REG", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+178,"io_axi_ar_pc", false,-1, 31,0);
    tracep->declBit(c+179,"io_axi_ar_arvalid", false,-1);
    tracep->declBus(c+187,"rdata_reg", false,-1, 31,0);
    tracep->declBit(c+181,"rvalid_reg", false,-1);
    tracep->declBit(c+97,"arvalid_reg", false,-1);
    tracep->declBit(c+188,"rvalid_en", false,-1);
    tracep->pushNamePrefix("delay ");
    tracep->declBit(c+194,"clock", false,-1);
    tracep->declBit(c+195,"reset", false,-1);
    tracep->declBus(c+200,"io_inData", false,-1, 31,0);
    tracep->declBit(c+201,"io_inValid", false,-1);
    tracep->declBus(c+189,"io_outData", false,-1, 31,0);
    tracep->declBit(c+190,"io_delayDone", false,-1);
    tracep->declBus(c+98,"shiftReg", false,-1, 4,0);
    tracep->declBus(c+191,"counter", false,-1, 4,0);
    tracep->declBus(c+192,"dataReg", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("vlg_pc_read ");
    tracep->declBit(c+194,"clk", false,-1);
    tracep->declBus(c+193,"pc", false,-1, 31,0);
    tracep->declBit(c+179,"pc_en", false,-1);
    ...
    tracep->declBit(c+32,"io_b_mem_exu_bvalid", false,-1);
    tracep->declBit(c+33,"io_b_mem_exu_bready", false,-1);
    tracep->declBus(c+100,"rdata_reg", false,-1, 31,0);
    tracep->declBit(c+24,"rvalid_reg", false,-1);
    tracep->declBus(c+101,"rresp_reg", false,-1, 1,0);
    tracep->declBit(c+102,"arvalid_reg", false,-1);
    tracep->declBit(c+32,"bvalid_reg", false,-1);
    tracep->declBus(c+103,"bresp_reg", false,-1, 1,0);
    tracep->declBus(c+104,"waddr_reg", false,-1, 31,0);
    tracep->declBus(c+105,"wmask_reg", false,-1, 2,0);
    tracep->declBit(c+106,"awvalid_reg", false,-1);
    tracep->declBit(c+107,"wvalid_reg", false,-1);
    tracep->declBit(c+108,"rvalid_en", false,-1);
    tracep->declBit(c+109,"bvalid_en", false,-1);
    tracep->pushNamePrefix("delay ");
    tracep->declBit(c+194,"clock", false,-1);
    tracep->declBit(c+195,"reset", false,-1);
    ...
    tracep->declBit(c+194,"clock", false,-1);
    tracep->declBus(c+124,"m_waddr", false,-1, 31,0);
    tracep->declBus(c+125,"m_wdata", false,-1, 31,0);
    tracep->declBus(c+126,"m_wmask", false,-1, 31,0);
    tracep->declBit(c+127,"m_wen", false,-1);
    tracep->declBus(c+128,"m_raddr", false,-1, 31,0);
    tracep->declBus(c+129,"m_rmask", false,-1, 31,0);
    tracep->declBit(c+21,"m_ren", false,-1);
    tracep->declBus(c+130,"m_rdata", false,-1, 31,0);
    tracep->declBit(c+131,"m_wready", false,-1);
    tracep->popNamePrefix(2);
    ...
    tracep->declBit(c+41,"io_csr_wen_2", false,-1);
    tracep->declBus(c+40,"io_csr_wdata_2", false,-1, 31,0);
    tracep->declBus(c+170,"io_reg_read_raddr_1", false,-1, 4,0);
    tracep->declBus(c+171,"io_reg_read_rdata_1", false,-1, 31,0);
    tracep->declBus(c+172,"io_reg_read_raddr_2", false,-1, 4,0);
    tracep->declBus(c+173,"io_reg_read_rdata_2", false,-1, 31,0);
    tracep->declBus(c+174,"io_reg_read_csr_raddr", false,-1, 1,0);
    tracep->declBus(c+199,"io_reg_read_csr_rdata", false,-1, 31,0);
    tracep->declBus(c+94,"io_reg_read_csr_a5", false,-1, 31,0);
    tracep->declBus(c+95,"io_reg_read_mstatus", false,-1, 31,0);
    ...
    tracep->declBus(c+37,"io_csr_waddr_1", false,-1, 1,0);
    tracep->declBus(c+38,"io_csr_wdata_1", false,-1, 31,0);
    tracep->declBus(c+132,"csr_0", false,-1, 31,0);
    tracep->declBus(c+133,"csr_1", false,-1, 31,0);
    tracep->declBus(c+95,"csr_2", false,-1, 31,0);
    tracep->declBus(c+134,"csr_3", false,-1, 31,0);
    tracep->declBus(c+135,"reg_0", false,-1, 31,0);
    tracep->declBus(c+136,"reg_1", false,-1, 31,0);
    tracep->declBus(c+137,"reg_2", false,-1, 31,0);
    tracep->declBus(c+138,"reg_3", false,-1, 31,0);
    tracep->declBus(c+139,"reg_4", false,-1, 31,0);
    tracep->declBus(c+140,"reg_5", false,-1, 31,0);
    tracep->declBus(c+141,"reg_6", false,-1, 31,0);
    tracep->declBus(c+142,"reg_7", false,-1, 31,0);
    tracep->declBus(c+143,"reg_8", false,-1, 31,0);
    tracep->declBus(c+144,"reg_9", false,-1, 31,0);
    tracep->declBus(c+145,"reg_10", false,-1, 31,0);
    tracep->declBus(c+146,"reg_11", false,-1, 31,0);
    tracep->declBus(c+147,"reg_12", false,-1, 31,0);
    tracep->declBus(c+148,"reg_13", false,-1, 31,0);
    tracep->declBus(c+149,"reg_14", false,-1, 31,0);
    tracep->declBus(c+94,"reg_15", false,-1, 31,0);
    tracep->declBus(c+150,"reg_16", false,-1, 31,0);
    tracep->declBus(c+151,"reg_17", false,-1, 31,0);
    tracep->declBus(c+152,"reg_18", false,-1, 31,0);
    tracep->declBus(c+153,"reg_19", false,-1, 31,0);
    tracep->declBus(c+154,"reg_20", false,-1, 31,0);
    tracep->declBus(c+155,"reg_21", false,-1, 31,0);
    tracep->declBus(c+156,"reg_22", false,-1, 31,0);
    tracep->declBus(c+157,"reg_23", false,-1, 31,0);
    tracep->declBus(c+158,"reg_24", false,-1, 31,0);
    tracep->declBus(c+159,"reg_25", false,-1, 31,0);
    tracep->declBus(c+160,"reg_26", false,-1, 31,0);
    tracep->declBus(c+161,"reg_27", false,-1, 31,0);
    tracep->declBus(c+162,"reg_28", false,-1, 31,0);
    tracep->declBus(c+163,"reg_29", false,-1, 31,0);
    tracep->declBus(c+164,"reg_30", false,-1, 31,0);
    tracep->declBus(c+165,"reg_31", false,-1, 31,0);
    tracep->declBus(c+171,"casez_tmp", false,-1, 31,0);
    tracep->declBus(c+173,"casez_tmp_0", false,-1, 31,0);
    tracep->declBus(c+199,"casez_tmp_1", false,-1, 31,0);
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+69,(((4U == (IData)(vlSelf->top__DOT__IDU__DOT__exu_data_inst_type))
                               ? (IData)(vlSelf->top__DOT__EXU__DOT__mem_wen_reg)
                               : 0U)),32);
    bufp->fullBit(oldp+70,(((4U == (IData)(vlSelf->top__DOT__IDU__DOT__exu_data_inst_type)) 
                            & (IData)(vlSelf->top__DOT__EXU__DOT__idu2in_valid))));
    ...
    bufp->fullIData(oldp+90,(((0U == (IData)(vlSelf->top__DOT__EXU__DOT__delay_w__DOT__counter))
                               ...
                               : 0U)),32);
    bufp->fullBit(oldp+91,(((0U != (IData)(vlSelf->top__DOT__EXU__DOT__delay_w__DOT__counter)) 
    ...
    bufp->fullIData(oldp+94,(vlSelf->top__DOT__Reg__DOT__reg_15),32);
    bufp->fullIData(oldp+95,(vlSelf->top__DOT__Reg__DOT__csr_2),32);
    bufp->fullBit(oldp+96,(vlSelf->top__DOT__IDU__DOT__state));
    bufp->fullBit(oldp+97,(vlSelf->top__DOT__Inst_fetch__DOT__arvalid_reg));
    bufp->fullCData(oldp+98,(vlSelf->top__DOT__Inst_fetch__DOT__delay__DOT__shiftReg),5);
    bufp->fullIData(oldp+99,(vlSelf->top__DOT__Inst_fetch__DOT___vlg_pc_read_inst),32);
    bufp->fullIData(oldp+100,(vlSelf->top__DOT__Mem__DOT__rdata_reg),32);
    bufp->fullCData(oldp+101,(vlSelf->top__DOT__Mem__DOT__rresp_reg),2);
    bufp->fullBit(oldp+102,(vlSelf->top__DOT__Mem__DOT__arvalid_reg));
    bufp->fullCData(oldp+103,(vlSelf->top__DOT__Mem__DOT__bresp_reg),2);
    bufp->fullIData(oldp+104,(vlSelf->top__DOT__Mem__DOT__waddr_reg),32);
    bufp->fullCData(oldp+105,(vlSelf->top__DOT__Mem__DOT__wmask_reg),3);
    bufp->fullBit(oldp+106,(vlSelf->top__DOT__Mem__DOT__awvalid_reg));
    bufp->fullBit(oldp+107,(vlSelf->top__DOT__Mem__DOT__wvalid_reg));
    bufp->fullBit(oldp+108,(vlSelf->top__DOT__Mem__DOT__rvalid_en));
    bufp->fullBit(oldp+109,(vlSelf->top__DOT__Mem__DOT__bvalid_en));
    bufp->fullIData(oldp+110,(((IData)(vlSelf->top__DOT__EXU__DOT__io_ar_exu_mem_arvalid_0)
                                ? vlSelf->top__DOT__Mem__DOT___m_m_rdata
                                : 0U)),32);
    bufp->fullBit(oldp+111,(((IData)(vlSelf->top__DOT__EXU__DOT__io_ar_exu_mem_arvalid_0) 
                             & ((IData)(vlSelf->top__DOT__Mem__DOT__arvalid_reg) 
                                != (IData)(vlSelf->top__DOT__EXU__DOT__io_ar_exu_mem_arvalid_0)))));
    bufp->fullIData(oldp+112,(((0U == (IData)(vlSelf->top__DOT__Mem__DOT__delay__DOT__counter))
                                ? vlSelf->top__DOT__Mem__DOT__delay__DOT__dataReg
                                : 0U)),32);
    bufp->fullBit(oldp+113,(((~ (IData)(vlSelf->top__DOT__Mem__DOT__delay__DOT___GEN_0)) 
                             & ((0U != (IData)(vlSelf->top__DOT__Mem__DOT__delay__DOT__counter)) 
                                & (1U == (IData)(vlSelf->top__DOT__Mem__DOT__delay__DOT__counter))))));
    bufp->fullCData(oldp+114,(vlSelf->top__DOT__Mem__DOT__delay__DOT__shiftReg),5);
    bufp->fullCData(oldp+115,(vlSelf->top__DOT__Mem__DOT__delay__DOT__counter),5);
    bufp->fullIData(oldp+116,(vlSelf->top__DOT__Mem__DOT__delay__DOT__dataReg),32);
    bufp->fullIData(oldp+117,(((IData)(vlSelf->top__DOT__Mem__DOT___wready_reg_T)
                                ? (IData)(vlSelf->top__DOT__Mem__DOT___m_m_wready)
                                : 0U)),32);
    bufp->fullBit(oldp+118,(((IData)(vlSelf->top__DOT__Mem__DOT___wready_reg_T) 
                             & (((IData)(vlSelf->top__DOT__EXU__DOT__io_w_exu_mem_wvalid_0) 
                                ...
                                & ((IData)(vlSelf->top__DOT__EXU__DOT__io_w_exu_mem_wvalid_0) 
                                   & (((IData)(vlSelf->top__DOT__EXU__DOT__io_aw_exu_mem_awvalid_0) 
                                      ...
                                      & (IData)(vlSelf->top__DOT__EXU__DOT__io_aw_exu_mem_awvalid_0)))))));
    bufp->fullIData(oldp+119,(((0U == (IData)(vlSelf->top__DOT__Mem__DOT__delay_w__DOT__counter))
                                ? vlSelf->top__DOT__Mem__DOT__delay_w__DOT__dataReg
                                : 0U)),32);
    bufp->fullBit(oldp+120,(((~ (IData)(vlSelf->top__DOT__Mem__DOT__delay_w__DOT___GEN_0)) 
                             & ((0U != (IData)(vlSelf->top__DOT__Mem__DOT__delay_w__DOT__counter)) 
                                & (1U == (IData)(vlSelf->top__DOT__Mem__DOT__delay_w__DOT__counter))))));
    bufp->fullCData(oldp+121,(vlSelf->top__DOT__Mem__DOT__delay_w__DOT__shiftReg),5);
    bufp->fullCData(oldp+122,(vlSelf->top__DOT__Mem__DOT__delay_w__DOT__counter),5);
    bufp->fullIData(oldp+123,(vlSelf->top__DOT__Mem__DOT__delay_w__DOT__dataReg),32);
    bufp->fullIData(oldp+124,(((IData)(vlSelf->top__DOT__EXU__DOT__io_aw_exu_mem_awvalid_0)
                                ? vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr
                                : 0U)),32);
    bufp->fullIData(oldp+125,(((IData)(vlSelf->top__DOT__EXU__DOT__io_w_exu_mem_wvalid_0)
    ...
    bufp->fullIData(oldp+126,(((IData)(vlSelf->top__DOT__EXU__DOT__io_w_exu_mem_wvalid_0)
                                ...
                                : 0U)),32);
    bufp->fullBit(oldp+127,(((IData)(vlSelf->top__DOT__Mem__DOT___wready_reg_T) 
                             & (((IData)(vlSelf->top__DOT___EXU_io_w_exu_mem_wmask) 
                                 != (IData)(vlSelf->top__DOT__Mem__DOT__wmask_reg)) 
                                & (vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr 
                                   != vlSelf->top__DOT__Mem__DOT__waddr_reg)))));
    bufp->fullIData(oldp+128,(vlSelf->top__DOT__Mem__DOT___GEN),32);
    bufp->fullIData(oldp+129,(vlSelf->top__DOT__Mem__DOT___GEN_0),32);
    bufp->fullIData(oldp+130,(vlSelf->top__DOT__Mem__DOT___m_m_rdata),32);
    bufp->fullBit(oldp+131,(vlSelf->top__DOT__Mem__DOT___m_m_wready));
    bufp->fullIData(oldp+132,(vlSelf->top__DOT__Reg__DOT__csr_0),32);
    bufp->fullIData(oldp+133,(vlSelf->top__DOT__Reg__DOT__csr_1),32);
    bufp->fullIData(oldp+134,(vlSelf->top__DOT__Reg__DOT__csr_3),32);
    bufp->fullIData(oldp+135,(vlSelf->top__DOT__Reg__DOT__reg_0),32);
    bufp->fullIData(oldp+136,(vlSelf->top__DOT__Reg__DOT__reg_1),32);
    bufp->fullIData(oldp+137,(vlSelf->top__DOT__Reg__DOT__reg_2),32);
    bufp->fullIData(oldp+138,(vlSelf->top__DOT__Reg__DOT__reg_3),32);
    bufp->fullIData(oldp+139,(vlSelf->top__DOT__Reg__DOT__reg_4),32);
    bufp->fullIData(oldp+140,(vlSelf->top__DOT__Reg__DOT__reg_5),32);
    bufp->fullIData(oldp+141,(vlSelf->top__DOT__Reg__DOT__reg_6),32);
    bufp->fullIData(oldp+142,(vlSelf->top__DOT__Reg__DOT__reg_7),32);
    bufp->fullIData(oldp+143,(vlSelf->top__DOT__Reg__DOT__reg_8),32);
    bufp->fullIData(oldp+144,(vlSelf->top__DOT__Reg__DOT__reg_9),32);
    bufp->fullIData(oldp+145,(vlSelf->top__DOT__Reg__DOT__reg_10),32);
    bufp->fullIData(oldp+146,(vlSelf->top__DOT__Reg__DOT__reg_11),32);
    bufp->fullIData(oldp+147,(vlSelf->top__DOT__Reg__DOT__reg_12),32);
    bufp->fullIData(oldp+148,(vlSelf->top__DOT__Reg__DOT__reg_13),32);
    bufp->fullIData(oldp+149,(vlSelf->top__DOT__Reg__DOT__reg_14),32);
    bufp->fullIData(oldp+150,(vlSelf->top__DOT__Reg__DOT__reg_16),32);
    bufp->fullIData(oldp+151,(vlSelf->top__DOT__Reg__DOT__reg_17),32);
    bufp->fullIData(oldp+152,(vlSelf->top__DOT__Reg__DOT__reg_18),32);
    bufp->fullIData(oldp+153,(vlSelf->top__DOT__Reg__DOT__reg_19),32);
    bufp->fullIData(oldp+154,(vlSelf->top__DOT__Reg__DOT__reg_20),32);
    bufp->fullIData(oldp+155,(vlSelf->top__DOT__Reg__DOT__reg_21),32);
    bufp->fullIData(oldp+156,(vlSelf->top__DOT__Reg__DOT__reg_22),32);
    bufp->fullIData(oldp+157,(vlSelf->top__DOT__Reg__DOT__reg_23),32);
    bufp->fullIData(oldp+158,(vlSelf->top__DOT__Reg__DOT__reg_24),32);
    bufp->fullIData(oldp+159,(vlSelf->top__DOT__Reg__DOT__reg_25),32);
    bufp->fullIData(oldp+160,(vlSelf->top__DOT__Reg__DOT__reg_26),32);
    bufp->fullIData(oldp+161,(vlSelf->top__DOT__Reg__DOT__reg_27),32);
    bufp->fullIData(oldp+162,(vlSelf->top__DOT__Reg__DOT__reg_28),32);
    bufp->fullIData(oldp+163,(vlSelf->top__DOT__Reg__DOT__reg_29),32);
    bufp->fullIData(oldp+164,(vlSelf->top__DOT__Reg__DOT__reg_30),32);
    bufp->fullIData(oldp+165,(vlSelf->top__DOT__Reg__DOT__reg_31),32);
    bufp->fullBit(oldp+166,(vlSelf->top__DOT___EXU_io_out2ifu_valid));
    bufp->fullIData(oldp+167,(vlSelf->top__DOT__EXU__DOT__ifu_outdata_dnpc),32);
    bufp->fullBit(oldp+168,(vlSelf->top__DOT__IFU__DOT__rready_reg));
    bufp->fullIData(oldp+169,(vlSelf->top__DOT__IFU__DOT__inst_reg),32);
    bufp->fullCData(oldp+170,((0x1fU & (vlSelf->top__DOT__IFU__DOT__inst_reg 
                                        >> 0xfU))),5);
    bufp->fullIData(oldp+171,(vlSelf->top__DOT__Reg__DOT__casez_tmp),32);
    bufp->fullCData(oldp+172,((0x1fU & (vlSelf->top__DOT__IFU__DOT__inst_reg 
                                        >> 0x14U))),5);
    bufp->fullIData(oldp+173,(vlSelf->top__DOT__Reg__DOT__casez_tmp_0),32);
    bufp->fullCData(oldp+174,(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr),2);
    bufp->fullIData(oldp+175,(vlSelf->top__DOT__IDU__DOT__csr_imm),32);
    bufp->fullCData(oldp+176,(vlSelf->top__DOT__IDU__DOT__casez_tmp),5);
    bufp->fullCData(oldp+177,(vlSelf->top__DOT__IDU__DOT__casez_tmp_0),5);
    bufp->fullIData(oldp+178,((((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg) 
                                ...
                                : 0U)),32);
    bufp->fullBit(oldp+179,(vlSelf->top__DOT__IFU__DOT__arvalid_reg));
    bufp->fullIData(oldp+180,(((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg)
                                ? vlSelf->top__DOT__Inst_fetch__DOT__rdata_reg
                                : 0U)),32);
    bufp->fullBit(oldp+181,(vlSelf->top__DOT__Inst_fetch__DOT__rvalid_reg));
    bufp->fullBit(oldp+182,(vlSelf->top__DOT__IFU__DOT__m2EXUstate));
    bufp->fullBit(oldp+183,(vlSelf->top__DOT__IFU__DOT__exu2in_reg));
    bufp->fullIData(oldp+184,(vlSelf->top__DOT__IFU__DOT__indata_dnpc),32);
    bufp->fullIData(oldp+185,(vlSelf->top__DOT__IFU__DOT__ardata_reg),32);
    bufp->fullIData(oldp+186,(vlSelf->top__DOT__IFU__DOT__io_out_bits_pc_REG),32);
    bufp->fullIData(oldp+187,(vlSelf->top__DOT__Inst_fetch__DOT__rdata_reg),32);
    bufp->fullBit(oldp+188,(vlSelf->top__DOT__Inst_fetch__DOT__rvalid_en));
    bufp->fullIData(oldp+189,(((0U == (IData)(vlSelf->top__DOT__Inst_fetch__DOT__delay__DOT__counter))
                                ? vlSelf->top__DOT__Inst_fetch__DOT__delay__DOT__dataReg
                                : 0U)),32);
    bufp->fullBit(oldp+190,(((~ (IData)(vlSelf->top__DOT__Inst_fetch__DOT__delay__DOT___GEN_0)) 
    ...
    bufp->fullCData(oldp+191,(vlSelf->top__DOT__Inst_fetch__DOT__delay__DOT__counter),5);
    bufp->fullIData(oldp+192,(vlSelf->top__DOT__Inst_fetch__DOT__delay__DOT__dataReg),32);
    bufp->fullIData(oldp+193,(((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg)
                                ? (((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg) 
                                    & (IData)(vlSelf->top__DOT__IFU__DOT__m2EXUstate))
                                    ? vlSelf->top__DOT__IFU__DOT__ardata_reg
                                    : 0U) : 0U)),32);
    bufp->fullBit(oldp+194,(vlSelf->clock));
    bufp->fullBit(oldp+195,(vlSelf->reset));
    bufp->fullIData(oldp+196,(vlSelf->io_pc),32);
    bufp->fullBit(oldp+197,(vlSelf->io_inv_flag));
    bufp->fullIData(oldp+198,(((IData)(4U) + vlSelf->io_pc)),32);
    bufp->fullIData(oldp+199,(((0U == (IData)(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr))
    ...
    bufp->fullIData(oldp+200,(((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg)
                                ? vlSelf->top__DOT__Inst_fetch__DOT___vlg_pc_read_inst
                                : 0U)),32);
    bufp->fullBit(oldp+201,(((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg) 
                             & ((IData)(vlSelf->top__DOT__Inst_fetch__DOT__arvalid_reg) 
                                != (IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg)))));
    bufp->fullIData(oldp+202,(0U),32);
    bufp->fullBit(oldp+203,(0U));
    bufp->fullIData(oldp+204,(vlSelf->top__DOT__EXU__DOT__delay_w__DOT__dataReg),32);
}
