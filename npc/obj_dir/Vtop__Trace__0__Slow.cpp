...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+76,"io_inv_flag", false,-1);
    ...
    tracep->declBus(c+59,"io_reg_wdata", false,-1, 31,0);
    tracep->declBit(c+40,"io_reg_wen", false,-1);
    tracep->declBus(c+60,"io_reg_waddr", false,-1, 4,0);
    ...
    tracep->declBus(c+61,"io_src1", false,-1, 31,0);
    tracep->declBus(c+62,"io_src2", false,-1, 31,0);
    tracep->declBus(c+63,"io_alu_op", false,-1, 3,0);
    tracep->declBus(c+64,"io_result", false,-1, 31,0);
    ...
    tracep->declBus(c+65,"m_raddr", false,-1, 31,0);
    tracep->declBus(c+66,"m_rmask", false,-1, 31,0);
    ...
    tracep->declBus(c+68,"io_ifu2in_bits_inst", false,-1, 31,0);
    ...
    tracep->declBus(c+69,"io_reg_data_raddr_1", false,-1, 4,0);
    tracep->declBus(c+54,"io_reg_data_rdata_1", false,-1, 31,0);
    tracep->declBus(c+70,"io_reg_data_raddr_2", false,-1, 4,0);
    ...
    tracep->declBus(c+71,"casez_tmp", false,-1, 3,0);
    tracep->declBus(c+72,"casez_tmp_0", false,-1, 3,0);
    ...
    tracep->declBus(c+68,"io_out_bits_inst", false,-1, 31,0);
    ...
    tracep->declBit(c+73,"clock", false,-1);
    tracep->declBit(c+74,"reset", false,-1);
    tracep->declBus(c+69,"io_reg_read_raddr_1", false,-1, 4,0);
    tracep->declBus(c+54,"io_reg_read_rdata_1", false,-1, 31,0);
    tracep->declBus(c+70,"io_reg_read_raddr_2", false,-1, 4,0);
    tracep->declBus(c+55,"io_reg_read_rdata_2", false,-1, 31,0);
    tracep->declBit(c+40,"io_wen", false,-1);
    tracep->declBus(c+60,"io_waddr", false,-1, 4,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+59,(vlSelf->top__DOT___EXU_io_reg_wdata),32);
    bufp->fullCData(oldp+60,(vlSelf->top__DOT___EXU_io_reg_waddr),5);
    bufp->fullIData(oldp+61,(vlSelf->top__DOT__EXU__DOT____Vcellinp__alu__io_src1),32);
    bufp->fullIData(oldp+62,(vlSelf->top__DOT__EXU__DOT____Vcellinp__alu__io_src2),32);
    bufp->fullCData(oldp+63,(vlSelf->top__DOT__EXU__DOT____Vcellinp__alu__io_alu_op),4);
    bufp->fullIData(oldp+64,(vlSelf->top__DOT__EXU__DOT__alu__DOT__casez_tmp),32);
    bufp->fullIData(oldp+65,(((IData)(vlSelf->top__DOT__EXU__DOT___GEN_3)
                               ? 0U : vlSelf->top__DOT__EXU__DOT__alu__DOT__casez_tmp)),32);
    bufp->fullIData(oldp+66,(((IData)(vlSelf->top__DOT__EXU__DOT___GEN_3)
                               ? 0U : vlSelf->top__DOT___IDU_io_out2exu_bits_m_rmask)),32);
    bufp->fullIData(oldp+67,(vlSelf->top__DOT__EXU__DOT___mem_m_rdata),32);
    bufp->fullIData(oldp+68,(vlSelf->top__DOT__IFU__DOT___vlg_pc_read_inst),32);
    bufp->fullCData(oldp+69,((0x1fU & (vlSelf->top__DOT__IFU__DOT___vlg_pc_read_inst 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+70,((0x1fU & (vlSelf->top__DOT__IFU__DOT___vlg_pc_read_inst 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+71,(vlSelf->top__DOT__IDU__DOT__casez_tmp),4);
    bufp->fullCData(oldp+72,(vlSelf->top__DOT__IDU__DOT__casez_tmp_0),4);
    bufp->fullBit(oldp+73,(vlSelf->clock));
    bufp->fullBit(oldp+74,(vlSelf->reset));
    bufp->fullIData(oldp+75,(vlSelf->io_pc),32);
    bufp->fullBit(oldp+76,(vlSelf->io_inv_flag));
    bufp->fullBit(oldp+77,(vlSelf->top__DOT__IFU__DOT__vlg_pc_read__DOT__clk));
}
