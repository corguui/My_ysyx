...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+118,"io_inv_flag", false,-1);
    ...
    tracep->declBit(c+63,"io_out2ifu_valid", false,-1);
    tracep->declBus(c+72,"io_out2ifu_bits_dnpc", false,-1, 31,0);
    tracep->declBus(c+73,"io_ar_exu_mem_raddr", false,-1, 31,0);
    tracep->declBus(c+74,"io_ar_exu_mem_rmask", false,-1, 2,0);
    tracep->declBit(c+75,"io_ar_exu_mem_arvalid", false,-1);
    tracep->declBit(c+76,"io_ar_exu_mem_arready", false,-1);
    tracep->declBus(c+77,"io_r_mem_exu_rdata", false,-1, 31,0);
    tracep->declBus(c+78,"io_r_mem_exu_rresp", false,-1, 1,0);
    tracep->declBit(c+76,"io_r_mem_exu_rvalid", false,-1);
    tracep->declBus(c+79,"io_w_exu_mem_wdata", false,-1, 31,0);
    tracep->declBus(c+64,"io_w_exu_mem_wmask", false,-1, 2,0);
    tracep->declBit(c+80,"io_w_exu_mem_wvalid", false,-1);
    tracep->declBus(c+81,"io_aw_exu_mem_awaddr", false,-1, 31,0);
    tracep->declBit(c+80,"io_aw_exu_mem_awvalid", false,-1);
    tracep->declBit(c+65,"io_b_mem_exu_bvalid", false,-1);
    ...
    tracep->declBit(c+87,"io_csr_wen_2", false,-1);
    tracep->declBus(c+72,"ifu_outdata_dnpc", false,-1, 31,0);
    tracep->declBit(c+88,"memwen_reg_en", false,-1);
    tracep->declBit(c+89,"m2IDUstate", false,-1);
    tracep->declBus(c+90,"lastdnpc", false,-1, 31,0);
    tracep->declBit(c+17,"reg_wen_reg", false,-1);
    tracep->declBit(c+18,"mem_ren_reg", false,-1);
    tracep->pushNamePrefix("alu ");
    tracep->declBus(c+91,"io_src1", false,-1, 31,0);
    tracep->declBus(c+92,"io_src2", false,-1, 31,0);
    tracep->declBus(c+93,"io_alu_op", false,-1, 4,0);
    tracep->declBus(c+94,"io_result", false,-1, 31,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("IDU ");
    tracep->declBit(c+115,"clock", false,-1);
    tracep->declBit(c+116,"reset", false,-1);
    tracep->declBit(c+95,"io_ifu2in_valid", false,-1);
    tracep->declBus(c+119,"io_ifu2in_bits_snpc", false,-1, 31,0);
    tracep->declBus(c+117,"io_ifu2in_bits_pc", false,-1, 31,0);
    tracep->declBus(c+96,"io_ifu2in_bits_inst", false,-1, 31,0);
    ...
    tracep->declBus(c+97,"io_reg_data_raddr_1", false,-1, 4,0);
    tracep->declBus(c+98,"io_reg_data_rdata_1", false,-1, 31,0);
    tracep->declBus(c+99,"io_reg_data_raddr_2", false,-1, 4,0);
    tracep->declBus(c+100,"io_reg_data_rdata_2", false,-1, 31,0);
    tracep->declBus(c+101,"io_reg_data_csr_raddr", false,-1, 1,0);
    ...
    tracep->declBus(c+102,"csr_imm", false,-1, 31,0);
    tracep->declBus(c+103,"casez_tmp", false,-1, 4,0);
    tracep->declBus(c+104,"casez_tmp_0", false,-1, 4,0);
    ...
    tracep->declBit(c+115,"clock", false,-1);
    tracep->declBit(c+116,"reset", false,-1);
    tracep->declBit(c+95,"io_out_valid", false,-1);
    tracep->declBus(c+119,"io_out_bits_snpc", false,-1, 31,0);
    tracep->declBus(c+117,"io_out_bits_pc", false,-1, 31,0);
    tracep->declBus(c+96,"io_out_bits_inst", false,-1, 31,0);
    tracep->declBit(c+63,"io_exu2in_valid", false,-1);
    tracep->declBus(c+72,"io_exu2in_bits_dnpc", false,-1, 31,0);
    tracep->declBit(c+105,"m2EXUstate", false,-1);
    tracep->declBus(c+106,"lastpc", false,-1, 31,0);
    tracep->declBus(c+107,"lastsnpc", false,-1, 31,0);
    tracep->declBit(c+95,"lasten", false,-1);
    tracep->declBus(c+96,"lastinst", false,-1, 31,0);
    tracep->declBus(c+108,"out_data_pc_REG", false,-1, 31,0);
    tracep->declBus(c+117,"out_data_pc", false,-1, 31,0);
    tracep->pushNamePrefix("vlg_pc_read ");
    tracep->declBit(c+115,"clk", false,-1);
    tracep->declBus(c+117,"pc", false,-1, 31,0);
    tracep->declBit(c+105,"pc_en", false,-1);
    ...
    tracep->declBus(c+77,"io_r_mem_exu_rdata_0", false,-1, 31,0);
    tracep->pushNamePrefix("m ");
    tracep->declBit(c+115,"clock", false,-1);
    tracep->declBus(c+69,"m_waddr", false,-1, 31,0);
    tracep->declBus(c+109,"m_wdata", false,-1, 31,0);
    tracep->declBus(c+70,"m_wmask", false,-1, 31,0);
    tracep->declBit(c+110,"m_wen", false,-1);
    tracep->declBus(c+111,"m_raddr", false,-1, 31,0);
    tracep->declBus(c+112,"m_rmask", false,-1, 31,0);
    tracep->declBit(c+113,"m_ren", false,-1);
    tracep->declBus(c+114,"m_rdata", false,-1, 31,0);
    ...
    tracep->declBit(c+87,"io_csr_wen_2", false,-1);
    tracep->declBus(c+67,"io_csr_wdata_2", false,-1, 31,0);
    tracep->declBus(c+97,"io_reg_read_raddr_1", false,-1, 4,0);
    tracep->declBus(c+98,"io_reg_read_rdata_1", false,-1, 31,0);
    tracep->declBus(c+99,"io_reg_read_raddr_2", false,-1, 4,0);
    tracep->declBus(c+100,"io_reg_read_rdata_2", false,-1, 31,0);
    tracep->declBus(c+101,"io_reg_read_csr_raddr", false,-1, 1,0);
    ...
    tracep->declBus(c+98,"casez_tmp", false,-1, 31,0);
    tracep->declBus(c+100,"casez_tmp_0", false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+28,(vlSelf->top__DOT__Mem__DOT___m_m_wready));
    ...
    bufp->fullCData(oldp+64,(((IData)(vlSelf->top__DOT__EXU__DOT___GEN_10)
                               ? 0U : (7U & vlSelf->top__DOT__IDU__DOT__exu_data_m_wmask))),3);
    bufp->fullBit(oldp+65,(((IData)(vlSelf->top__DOT__Mem__DOT___GEN_1) 
                            & (IData)(vlSelf->top__DOT__Mem__DOT___m_m_wready))));
    ...
    bufp->fullIData(oldp+69,((((IData)(vlSelf->top__DOT___EXU_io_w_exu_mem_wvalid) 
                               & (vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr 
                                  != vlSelf->top__DOT__Mem__DOT__lastawaddr))
                               ? vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr
                               : 0U)),32);
    bufp->fullIData(oldp+70,(((IData)(vlSelf->top__DOT__Mem__DOT___GEN_1)
    ...
    bufp->fullIData(oldp+73,(vlSelf->top__DOT___EXU_io_ar_exu_mem_raddr),32);
    bufp->fullCData(oldp+74,(vlSelf->top__DOT___EXU_io_ar_exu_mem_rmask),3);
    bufp->fullBit(oldp+75,(vlSelf->top__DOT___EXU_io_ar_exu_mem_arvalid));
    ...
    bufp->fullIData(oldp+77,(((IData)(vlSelf->top__DOT__Mem__DOT__io_r_mem_exu_rvalid_0)
                               ...
                               : 0U)),32);
    bufp->fullCData(oldp+78,((((IData)(vlSelf->top__DOT__Mem__DOT__io_r_mem_exu_rvalid_0) 
                               ...
                               : 0U)),2);
    bufp->fullIData(oldp+79,(vlSelf->top__DOT___EXU_io_w_exu_mem_wdata),32);
    bufp->fullBit(oldp+80,(vlSelf->top__DOT___EXU_io_w_exu_mem_wvalid));
    bufp->fullIData(oldp+81,(vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr),32);
    ...
    bufp->fullBit(oldp+87,(((IData)(vlSelf->top__DOT__EXU__DOT__m2IDUstate) 
                            & ((~ (IData)(vlSelf->top__DOT__EXU__DOT___GEN_26)) 
                               & (0xcU == (IData)(vlSelf->top__DOT__IDU__DOT__exu_data_inst_type))))));
    bufp->fullBit(oldp+88,(vlSelf->top__DOT__EXU__DOT__memwen_reg_en));
    bufp->fullBit(oldp+89,(vlSelf->top__DOT__EXU__DOT__m2IDUstate));
    bufp->fullIData(oldp+90,(vlSelf->top__DOT__EXU__DOT__lastdnpc),32);
    bufp->fullIData(oldp+91,(vlSelf->top__DOT__EXU__DOT____Vcellinp__alu__io_src1),32);
    bufp->fullIData(oldp+92,(vlSelf->top__DOT__EXU__DOT____Vcellinp__alu__io_src2),32);
    bufp->fullCData(oldp+93,(vlSelf->top__DOT__EXU__DOT____Vcellinp__alu__io_alu_op),5);
    bufp->fullIData(oldp+94,(vlSelf->top__DOT__EXU__DOT___alu_io_result),32);
    bufp->fullBit(oldp+95,(vlSelf->top__DOT__IFU__DOT__lasten));
    bufp->fullIData(oldp+96,(vlSelf->top__DOT__IFU__DOT__lastinst),32);
    bufp->fullCData(oldp+97,((0x1fU & (vlSelf->top__DOT__IFU__DOT__lastinst 
                                       >> 0xfU))),5);
    bufp->fullIData(oldp+98,(vlSelf->top__DOT__Reg__DOT__casez_tmp),32);
    bufp->fullCData(oldp+99,((0x1fU & (vlSelf->top__DOT__IFU__DOT__lastinst 
                                       >> 0x14U))),5);
    bufp->fullIData(oldp+100,(vlSelf->top__DOT__Reg__DOT__casez_tmp_0),32);
    bufp->fullCData(oldp+101,(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr),2);
    bufp->fullIData(oldp+102,(vlSelf->top__DOT__IDU__DOT__csr_imm),32);
    bufp->fullCData(oldp+103,(vlSelf->top__DOT__IDU__DOT__casez_tmp),5);
    bufp->fullCData(oldp+104,(vlSelf->top__DOT__IDU__DOT__casez_tmp_0),5);
    bufp->fullBit(oldp+105,(vlSelf->top__DOT__IFU__DOT__m2EXUstate));
    bufp->fullIData(oldp+106,(vlSelf->top__DOT__IFU__DOT__lastpc),32);
    bufp->fullIData(oldp+107,(vlSelf->top__DOT__IFU__DOT__lastsnpc),32);
    bufp->fullIData(oldp+108,(vlSelf->top__DOT__IFU__DOT__out_data_pc_REG),32);
    bufp->fullIData(oldp+109,(((IData)(vlSelf->top__DOT__Mem__DOT___GEN_1)
                                ? vlSelf->top__DOT___EXU_io_w_exu_mem_wdata
                                : 0U)),32);
    bufp->fullBit(oldp+110,(((IData)(vlSelf->top__DOT__Mem__DOT___GEN_1) 
                             & (IData)(vlSelf->top__DOT___EXU_io_w_exu_mem_wvalid))));
    bufp->fullIData(oldp+111,(vlSelf->top__DOT__Mem__DOT___GEN),32);
    bufp->fullIData(oldp+112,(((IData)(vlSelf->top__DOT__Mem__DOT__io_r_mem_exu_rvalid_0)
                                ? (IData)(vlSelf->top__DOT___EXU_io_ar_exu_mem_rmask)
                                : 0U)),32);
    bufp->fullBit(oldp+113,(((IData)(vlSelf->top__DOT__Mem__DOT__io_r_mem_exu_rvalid_0) 
                             & (IData)(vlSelf->top__DOT___EXU_io_ar_exu_mem_arvalid))));
    bufp->fullIData(oldp+114,(vlSelf->top__DOT__Mem__DOT___m_m_rdata),32);
    bufp->fullBit(oldp+115,(vlSelf->clock));
    bufp->fullBit(oldp+116,(vlSelf->reset));
    bufp->fullIData(oldp+117,(vlSelf->io_pc),32);
    bufp->fullBit(oldp+118,(vlSelf->io_inv_flag));
    bufp->fullIData(oldp+119,(((IData)(vlSelf->top__DOT__IFU__DOT__m2EXUstate)
