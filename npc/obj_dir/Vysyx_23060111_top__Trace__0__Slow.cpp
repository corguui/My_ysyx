...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+13,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                       >> 7U))),5);
    bufp->fullCData(oldp+14,(vlSelf->ysyx_23060111_top__DOT__funct3),3);
    ...
    bufp->fullCData(oldp+16,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+17,(vlSelf->ysyx_23060111_top__DOT__funct7),7);
    bufp->fullIData(oldp+18,(vlSelf->ysyx_23060111_top__DOT__imm),32);
    ...
    bufp->fullIData(oldp+125,(vlSelf->ysyx_23060111_top__DOT__snpc),32);
