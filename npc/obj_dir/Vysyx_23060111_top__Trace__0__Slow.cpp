...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+77,"rbb", false,-1, 31,0);
    ...
    tracep->declBus(c+78,"snpc", false,-1, 31,0);
    tracep->declBus(c+79,"opcode", false,-1, 6,0);
    tracep->declBus(c+80,"rd", false,-1, 11,7);
    tracep->declBus(c+81,"funct3", false,-1, 14,12);
    tracep->declBus(c+82,"rs1", false,-1, 19,15);
    tracep->declBus(c+83,"rs2", false,-1, 24,20);
    tracep->declBus(c+84,"funct7", false,-1, 31,25);
    tracep->declBus(c+6,"type_i", false,-1, 3,0);
    tracep->declBus(c+7,"imm", false,-1, 31,0);
    tracep->declBus(c+86,"wdata", false,-1, 31,0);
    tracep->declBus(c+87,"waddr", false,-1, 4,0);
    tracep->declBus(c+88,"raddr", false,-1, 4,0);
    tracep->declBit(c+89,"wen", false,-1);
    tracep->declBus(c+40,"rout", false,-1, 31,0);
    ...
    tracep->declBus(c+90,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+91,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+92,"DATA_LEN", false,-1, 31,0);
    tracep->declQuad(c+8,"out", false,-1, 35,0);
    tracep->declBus(c+79,"key", false,-1, 6,0);
    tracep->declQuad(c+93,"default_out", false,-1, 35,0);
    tracep->declArray(c+10,"lut", false,-1, 214,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+90,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+91,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+92,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+95,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declQuad(c+8,"out", false,-1, 35,0);
    tracep->declBus(c+79,"key", false,-1, 6,0);
    tracep->declQuad(c+93,"default_out", false,-1, 35,0);
    tracep->declArray(c+10,"lut", false,-1, 214,0);
    tracep->declBus(c+96,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 5; ++i) {
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+6,((0xfU & (IData)((vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellout__i0____pinNumber1 
                                             >> 0x20U)))),4);
    ...
    bufp->fullIData(oldp+40,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf
                             [vlSelf->ysyx_23060111_top__DOT__raddr]),32);
    bufp->fullIData(oldp+41,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[0]),32);
    bufp->fullIData(oldp+42,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[1]),32);
    bufp->fullIData(oldp+43,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[2]),32);
    bufp->fullIData(oldp+44,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[3]),32);
    bufp->fullIData(oldp+45,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[4]),32);
    bufp->fullIData(oldp+46,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[5]),32);
    bufp->fullIData(oldp+47,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[6]),32);
    bufp->fullIData(oldp+48,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[7]),32);
    bufp->fullIData(oldp+49,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[8]),32);
    bufp->fullIData(oldp+50,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[9]),32);
    bufp->fullIData(oldp+51,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[10]),32);
    bufp->fullIData(oldp+52,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[11]),32);
    bufp->fullIData(oldp+53,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[12]),32);
    bufp->fullIData(oldp+54,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[13]),32);
    bufp->fullIData(oldp+55,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[14]),32);
    bufp->fullIData(oldp+56,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[15]),32);
    bufp->fullIData(oldp+57,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[16]),32);
    bufp->fullIData(oldp+58,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[17]),32);
    bufp->fullIData(oldp+59,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[18]),32);
    bufp->fullIData(oldp+60,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[19]),32);
    bufp->fullIData(oldp+61,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[20]),32);
    bufp->fullIData(oldp+62,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[21]),32);
    bufp->fullIData(oldp+63,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[22]),32);
    bufp->fullIData(oldp+64,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[23]),32);
    bufp->fullIData(oldp+65,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[24]),32);
    bufp->fullIData(oldp+66,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[25]),32);
    bufp->fullIData(oldp+67,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[26]),32);
    bufp->fullIData(oldp+68,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[27]),32);
    bufp->fullIData(oldp+69,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[28]),32);
    bufp->fullIData(oldp+70,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[29]),32);
    bufp->fullIData(oldp+71,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[30]),32);
    bufp->fullIData(oldp+72,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[31]),32);
    ...
    bufp->fullIData(oldp+77,(vlSelf->rbb),32);
    bufp->fullIData(oldp+78,(((IData)(4U) + vlSelf->pc)),32);
    ...
    bufp->fullCData(oldp+83,((0x1fU & (vlSelf->inst 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+84,((vlSelf->inst >> 0x19U)),7);
    bufp->fullIData(oldp+85,(vlSelf->ysyx_23060111_top__DOT__dnpc),32);
    bufp->fullIData(oldp+86,(vlSelf->ysyx_23060111_top__DOT__wdata),32);
    bufp->fullCData(oldp+87,(vlSelf->ysyx_23060111_top__DOT__waddr),5);
    bufp->fullCData(oldp+88,(vlSelf->ysyx_23060111_top__DOT__raddr),5);
    bufp->fullBit(oldp+89,(vlSelf->ysyx_23060111_top__DOT__wen));
    bufp->fullIData(oldp+90,(5U),32);
    bufp->fullIData(oldp+91,(7U),32);
    bufp->fullIData(oldp+92,(0x24U),32);
    bufp->fullQData(oldp+93,(0ULL),36);
    bufp->fullIData(oldp+95,(1U),32);
    bufp->fullIData(oldp+96,(0x2bU),32);
