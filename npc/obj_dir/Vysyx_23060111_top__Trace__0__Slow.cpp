...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBit(c+1,"ysyx_23060111_top.rst", false,-1);
    tracep->declBit(c+2,"ysyx_23060111_top.clk", false,-1);
    ...
    tracep->declBit(c+17,"ysyx_23060111_trigger.clk", false,-1);
    tracep->declBit(c+18,"ysyx_23060111_trigger.rst", false,-1);
    tracep->declBus(c+19,"din", false,-1, 0,0);
    tracep->declBus(c+20,"dout", false,-1, 0,0);
    ...
    tracep->declBus(c+22,"imm_32", false,-1, 31,0);
    tracep->pushNamePrefix("reg_rd ");
    tracep->declBus(c+28,"ADDR_WIDTH", false,-1, 31,0);
    ...
    tracep->declBit(c+2,"clk", false,-1);
    tracep->declBus(c+31,"wdata", false,-1, 31,0);
    tracep->declBus(c+32,"waddr", false,-1, 0,0);
    tracep->declBit(c+30,"wen", false,-1);
    tracep->declBus(c+13,"out", false,-1, 31,0);
    for (int i = 0; i < 1; ++i) {
    ...
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("ysyx_23060111_trigger ");
    tracep->declBus(c+28,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+31,"RESET_VAL", false,-1, 31,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelf->ysyx_23060111_top__02Erst));
    bufp->fullBit(oldp+2,(vlSelf->ysyx_23060111_top__02Eclk));
    ...
    bufp->fullBit(oldp+17,(vlSelf->ysyx_23060111_trigger__02Eclk));
    bufp->fullBit(oldp+18,(vlSelf->ysyx_23060111_trigger__02Erst));
    bufp->fullBit(oldp+19,(vlSelf->din));
    bufp->fullBit(oldp+20,(vlSelf->dout));
    bufp->fullBit(oldp+21,(vlSelf->wen));
    bufp->fullIData(oldp+22,((vlSelf->inst >> 0x14U)),32);
    bufp->fullIData(oldp+23,((vlSelf->reg_out + (vlSelf->inst 
                                                 >> 0x14U))),32);
    bufp->fullBit(oldp+24,((1U & (vlSelf->inst >> 7U))));
    bufp->fullIData(oldp+25,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_rd__DOT__rf[0]),32);
    bufp->fullBit(oldp+26,((1U & (vlSelf->inst >> 0xfU))));
    bufp->fullIData(oldp+27,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[0]),32);
    bufp->fullIData(oldp+28,(1U),32);
    bufp->fullIData(oldp+29,(0x20U),32);
    bufp->fullBit(oldp+30,(1U));
    bufp->fullIData(oldp+31,(0U),32);
    bufp->fullBit(oldp+32,(0U));
    bufp->fullIData(oldp+33,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_src1__DOT__rf[0]),32);
}
