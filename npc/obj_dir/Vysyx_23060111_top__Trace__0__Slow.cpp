...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+92,"rd", false,-1, 11,7);
    tracep->declBus(c+93,"funct3", false,-1, 14,12);
    tracep->declBus(c+94,"rs1", false,-1, 19,15);
    tracep->declBus(c+95,"rs2", false,-1, 24,20);
    tracep->declBus(c+96,"funct7", false,-1, 31,25);
    tracep->declBus(c+8,"type_i", false,-1, 3,0);
    tracep->declBus(c+9,"imm", false,-1, 31,0);
    tracep->declBus(c+101,"wdata", false,-1, 31,0);
    tracep->declBus(c+92,"waddr", false,-1, 4,0);
    tracep->declBus(c+94,"raddr", false,-1, 4,0);
    tracep->declBit(c+102,"wen", false,-1);
    tracep->declBus(c+97,"rout", false,-1, 31,0);
    ...
    tracep->declBus(c+99,"data", false,-1, 31,0);
    ...
    tracep->declBus(c+91,"key", false,-1, 6,0);
    tracep->declQuad(c+105,"default_out", false,-1, 36,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+92,((0x1fU & (vlSelf->inst 
                                       >> 7U))),5);
    bufp->fullCData(oldp+93,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->fullCData(oldp+94,((0x1fU & (vlSelf->inst 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+95,((0x1fU & (vlSelf->inst 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+96,((vlSelf->inst >> 0x19U)),7);
    bufp->fullIData(oldp+97,(vlSelf->ysyx_23060111_top__DOT__rout),32);
    bufp->fullIData(oldp+98,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__dnpc),32);
    bufp->fullIData(oldp+99,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__data),32);
    bufp->fullIData(oldp+100,(vlSelf->ysyx_23060111_top__DOT__snpc),32);
    bufp->fullIData(oldp+101,(vlSelf->ysyx_23060111_top__DOT__wdata),32);
    bufp->fullBit(oldp+102,(1U));
    bufp->fullIData(oldp+103,(7U),32);
    bufp->fullIData(oldp+104,(0x25U),32);
    bufp->fullQData(oldp+105,(1ULL),37);
    bufp->fullIData(oldp+107,(1U),32);
    bufp->fullIData(oldp+108,(0x2cU),32);
