...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+88,"inv_flag", false,-1);
    ...
    tracep->declBus(c+95,"rd", false,-1, 11,7);
    tracep->declBus(c+96,"funct3", false,-1, 14,12);
    tracep->declBus(c+97,"rs1", false,-1, 19,15);
    tracep->declBus(c+98,"rs2", false,-1, 24,20);
    tracep->declBus(c+99,"funct7", false,-1, 31,25);
    ...
    tracep->declBus(c+97,"raddr", false,-1, 4,0);
    tracep->declBit(c+100,"wen", false,-1);
    tracep->declBus(c+92,"rout", false,-1, 31,0);
    tracep->pushNamePrefix("IFU ");
    tracep->declBus(c+87,"pc", false,-1, 31,0);
    tracep->declBus(c+93,"inst", false,-1, 31,0);
    tracep->declBus(c+101,"len", false,-1, 31,0);
    ...
    tracep->declQuad(c+3,"out", false,-1, 36,0);
    tracep->declBus(c+94,"key", false,-1, 6,0);
    tracep->declQuad(c+104,"default_out", false,-1, 36,0);
    tracep->declArray(c+5,"lut", false,-1, 307,0);
    ...
    for (int i = 0; i < 7; ++i) {
        tracep->declQuad(c+15+i*2,"pair_list", true,(i+0), 43,0);
    }
    for (int i = 0; i < 7; ++i) {
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+2,((IData)((vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellout__typeMux____pinNumber1 
                                     >> 1U))),32);
    bufp->fullQData(oldp+3,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellout__typeMux____pinNumber1),37);
    bufp->fullWData(oldp+5,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellinp__typeMux____pinNumber4),308);
    bufp->fullQData(oldp+15,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[0]),44);
    bufp->fullQData(oldp+17,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[1]),44);
    bufp->fullQData(oldp+19,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[2]),44);
    bufp->fullQData(oldp+21,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[3]),44);
    bufp->fullQData(oldp+23,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[4]),44);
    bufp->fullQData(oldp+25,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[5]),44);
    bufp->fullQData(oldp+27,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[6]),44);
    bufp->fullCData(oldp+29,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__key_list[0]),7);
    bufp->fullCData(oldp+30,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__key_list[1]),7);
    bufp->fullCData(oldp+31,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__key_list[2]),7);
    bufp->fullCData(oldp+32,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__key_list[3]),7);
    bufp->fullCData(oldp+33,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__key_list[4]),7);
    bufp->fullCData(oldp+34,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__key_list[5]),7);
    bufp->fullCData(oldp+35,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__key_list[6]),7);
    ...
    bufp->fullBit(oldp+88,(vlSelf->inv_flag));
    bufp->fullIData(oldp+89,(vlSelf->ysyx_23060111_top__DOT__dnpc),32);
    bufp->fullIData(oldp+90,(((IData)(4U) + vlSelf->pc)),32);
    bufp->fullIData(oldp+91,(vlSelf->ysyx_23060111_top__DOT__wdata),32);
    bufp->fullIData(oldp+92,(vlSelf->ysyx_23060111_top__DOT__rout),32);
    bufp->fullIData(oldp+93,(vlSelf->ysyx_23060111_top__DOT__inst),32);
    bufp->fullCData(oldp+94,((0x7fU & vlSelf->ysyx_23060111_top__DOT__inst)),7);
    bufp->fullCData(oldp+95,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                       >> 7U))),5);
    bufp->fullCData(oldp+96,((7U & (vlSelf->ysyx_23060111_top__DOT__inst 
                                    >> 0xcU))),3);
    bufp->fullCData(oldp+97,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+98,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+99,((vlSelf->ysyx_23060111_top__DOT__inst 
                              >> 0x19U)),7);
