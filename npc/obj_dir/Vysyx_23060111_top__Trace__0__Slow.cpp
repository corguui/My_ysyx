...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declQuad(c+79,"rbb", false,-1, 35,0);
    ...
    tracep->declBus(c+81,"snpc", false,-1, 31,0);
    tracep->declBus(c+82,"opcode", false,-1, 6,0);
    tracep->declBus(c+83,"rd", false,-1, 11,7);
    tracep->declBus(c+84,"funct3", false,-1, 14,12);
    tracep->declBus(c+85,"rs1", false,-1, 19,15);
    tracep->declBus(c+86,"rs2", false,-1, 24,20);
    tracep->declBus(c+87,"funct7", false,-1, 31,25);
    tracep->declBus(c+6,"type_i", false,-1, 3,0);
    tracep->declBus(c+7,"imm", false,-1, 31,0);
    tracep->declBus(c+73,"wdata", false,-1, 31,0);
    tracep->declBus(c+83,"waddr", false,-1, 4,0);
    tracep->declBus(c+85,"raddr", false,-1, 4,0);
    ...
    tracep->declBus(c+82,"key", false,-1, 6,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+72,(vlSelf->ysyx_23060111_top__DOT__dnpc),32);
    bufp->fullIData(oldp+73,(vlSelf->ysyx_23060111_top__DOT__wdata),32);
    bufp->fullBit(oldp+74,(vlSelf->ysyx_23060111_top__DOT__wen));
    ...
    bufp->fullQData(oldp+79,(vlSelf->rbb),36);
    bufp->fullIData(oldp+81,(((IData)(4U) + vlSelf->pc)),32);
