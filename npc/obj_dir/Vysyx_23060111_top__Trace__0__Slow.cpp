...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+16,"rbb", false,-1, 20,0);
    tracep->declBus(c+17,"rbb1", false,-1, 9,0);
    ...
    tracep->declBus(c+14,"reg_out", false,-1, 31,0);
    tracep->declBus(c+15,"reg_out1", false,-1, 31,0);
    tracep->declBus(c+16,"out", false,-1, 20,0);
    tracep->declBus(c+18,"imm_32", false,-1, 31,0);
    ...
    tracep->declBus(c+30,"RESET_VAL", false,-1, 31,0);
    tracep->declBit(c+2,"clk", false,-1);
    tracep->declBit(c+1,"rst", false,-1);
    ...
    tracep->declBus(c+11,"rd", false,-1, 11,7);
    tracep->declBus(c+12,"opcode", false,-1, 6,0);
    tracep->declBus(c+17,"rbb", false,-1, 9,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+16,(vlSelf->rbb),21);
    bufp->fullSData(oldp+17,(vlSelf->rbb1),10);
    bufp->fullIData(oldp+18,((vlSelf->inst >> 0x14U)),32);
    bufp->fullIData(oldp+19,((vlSelf->reg_out + (vlSelf->inst 
                                                 >> 0x14U))),32);
    bufp->fullBit(oldp+20,((1U & (vlSelf->inst >> 7U))));
    bufp->fullIData(oldp+21,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__reg_rd__DOT__rf[0]),32);
    bufp->fullBit(oldp+22,((1U & (vlSelf->inst >> 0xfU))));
    bufp->fullIData(oldp+23,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf[0]),32);
    ...
    bufp->fullIData(oldp+30,(0x80000000U),32);
}
