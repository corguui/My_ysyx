...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+120,"m_raddr", false,-1, 31,0);
    tracep->declBit(c+121,"m_wen", false,-1);
    tracep->declBit(c+122,"m_ren", false,-1);
    ...
    tracep->declBus(c+139,"flag", false,-1, 31,0);
    tracep->declBus(c+123,"read_addr", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+119,(vlSelf->ysyx_23060111_top__DOT__m_rdata),32);
    bufp->fullIData(oldp+120,(vlSelf->ysyx_23060111_top__DOT__m_raddr),32);
    bufp->fullBit(oldp+121,(vlSelf->ysyx_23060111_top__DOT__m_wen));
    bufp->fullBit(oldp+122,(vlSelf->ysyx_23060111_top__DOT__m_ren));
    bufp->fullIData(oldp+123,(((IData)(vlSelf->ysyx_23060111_top__DOT__m_ren)
    ...
    bufp->fullBit(oldp+129,(vlSelf->ysyx_23060111_top__DOT__wen));
