...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+150,"inv_flag", false,-1);
    ...
    tracep->declBus(c+151,"snpc", false,-1, 31,0);
    ...
    tracep->declBus(c+66,"csr_waddr", false,-1, 1,0);
    tracep->declBus(c+67,"csr_wdata", false,-1, 31,0);
    tracep->declBus(c+68,"csr_raddr", false,-1, 1,0);
    tracep->declBit(c+69,"csr_wen", false,-1);
    tracep->declBit(c+70,"csr_mepc_wen", false,-1);
    tracep->declBit(c+71,"csr_mcause_wen", false,-1);
    tracep->declBit(c+72,"csr_mstatus_wen", false,-1);
    tracep->declBus(c+73,"csr_rout", false,-1, 31,0);
    ...
    tracep->declBus(c+74,"csr_mcause_wdata", false,-1, 31,0);
    tracep->declBus(c+75,"csr_mepc_wdata", false,-1, 31,0);
    tracep->declBus(c+76,"csr_mstatus_wdata", false,-1, 31,0);
    ...
    tracep->declBit(c+72,"csr_mstatus_wen", false,-1);
    tracep->declBit(c+69,"csr_wen", false,-1);
    tracep->declBus(c+85,"csr_flag", false,-1, 1,0);
    ...
    tracep->declBus(c+85,"csr_flag", false,-1, 1,0);
    tracep->declBus(c+80,"m_rdata", false,-1, 31,0);
    tracep->declBit(c+86,"cond_beq", false,-1);
    tracep->declBit(c+87,"cond_bge", false,-1);
    tracep->declBit(c+88,"cond_bgeu", false,-1);
    tracep->declBus(c+64,"src1", false,-1, 31,0);
    tracep->declBus(c+65,"src2", false,-1, 31,0);
    tracep->declBus(c+73,"csr", false,-1, 31,0);
    ...
    for (int i = 0; i < 10; ++i) {
        tracep->declQuad(c+104+i*2,"pair_list", true,(i+0), 39,0);
    }
    for (int i = 0; i < 10; ++i) {
        tracep->declBus(c+1+i*1,"key_list", true,(i+0), 6,0);
    }
    for (int i = 0; i < 10; ++i) {
        tracep->declQuad(c+124+i*2,"data_list", true,(i+0), 32,0);
    }
    tracep->declQuad(c+144,"lut_out", false,-1, 32,0);
    ...
    tracep->declBit(c+71,"csr_mcause_wen", false,-1);
    tracep->declBit(c+70,"csr_mepc_wen", false,-1);
    tracep->declBit(c+72,"csrr_mstatus_wen", false,-1);
    tracep->declBus(c+64,"rout1", false,-1, 31,0);
    tracep->declBus(c+65,"rout2", false,-1, 31,0);
    tracep->declBus(c+11,"csr_a5", false,-1, 31,0);
    tracep->declBus(c+14,"csrr_mtvec", false,-1, 31,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+66,(vlSelf->ysyx_23060111_top__DOT__csr_waddr),2);
    bufp->fullIData(oldp+67,(vlSelf->ysyx_23060111_top__DOT__csr_wdata),32);
    bufp->fullCData(oldp+68,(vlSelf->ysyx_23060111_top__DOT__csr_raddr),2);
    bufp->fullBit(oldp+69,(vlSelf->ysyx_23060111_top__DOT__csr_wen));
    bufp->fullBit(oldp+70,(vlSelf->ysyx_23060111_top__DOT__csr_mepc_wen));
    bufp->fullBit(oldp+71,(vlSelf->ysyx_23060111_top__DOT__csr_mcause_wen));
    bufp->fullBit(oldp+72,(vlSelf->ysyx_23060111_top__DOT__csr_mstatus_wen));
    bufp->fullIData(oldp+73,(vlSelf->ysyx_23060111_top__DOT__csr_rout),32);
    bufp->fullIData(oldp+74,(vlSelf->ysyx_23060111_top__DOT__csr_mcause_wdata),32);
    bufp->fullIData(oldp+75,(vlSelf->ysyx_23060111_top__DOT__csr_mepc_wdata),32);
    bufp->fullIData(oldp+76,(vlSelf->ysyx_23060111_top__DOT__csr_mstatus_wdata),32);
    bufp->fullIData(oldp+77,(vlSelf->ysyx_23060111_top__DOT__m_waddr),32);
    bufp->fullIData(oldp+78,(vlSelf->ysyx_23060111_top__DOT__m_wdata),32);
    bufp->fullIData(oldp+79,(vlSelf->ysyx_23060111_top__DOT__m_wmask),32);
    bufp->fullIData(oldp+80,(vlSelf->ysyx_23060111_top__DOT__m_rdata),32);
    bufp->fullIData(oldp+81,(vlSelf->ysyx_23060111_top__DOT__m_raddr),32);
    bufp->fullIData(oldp+82,(vlSelf->ysyx_23060111_top__DOT__m_rmask),32);
    bufp->fullBit(oldp+83,(vlSelf->ysyx_23060111_top__DOT__m_wen));
    bufp->fullBit(oldp+84,(vlSelf->ysyx_23060111_top__DOT__m_ren));
    bufp->fullCData(oldp+85,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__csr_flag),2);
    bufp->fullBit(oldp+86,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__ALU_init__DOT__cond_beq));
    bufp->fullBit(oldp+87,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__ALU_init__DOT__cond_bge));
    bufp->fullBit(oldp+88,(vlSelf->ysyx_23060111_top__DOT__init_EXU__DOT__ALU_init__DOT__cond_bgeu));
    bufp->fullQData(oldp+89,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellout__typeMux____pinNumber1),33);
    bufp->fullWData(oldp+91,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellinp__typeMux____pinNumber4),400);
    bufp->fullQData(oldp+104,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[0]),40);
    bufp->fullQData(oldp+106,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[1]),40);
    bufp->fullQData(oldp+108,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[2]),40);
    bufp->fullQData(oldp+110,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[3]),40);
    bufp->fullQData(oldp+112,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[4]),40);
    bufp->fullQData(oldp+114,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[5]),40);
    bufp->fullQData(oldp+116,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[6]),40);
    bufp->fullQData(oldp+118,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[7]),40);
    bufp->fullQData(oldp+120,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[8]),40);
    bufp->fullQData(oldp+122,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[9]),40);
    bufp->fullQData(oldp+124,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[0]),33);
    bufp->fullQData(oldp+126,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[1]),33);
    bufp->fullQData(oldp+128,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[2]),33);
    bufp->fullQData(oldp+130,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[3]),33);
    bufp->fullQData(oldp+132,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[4]),33);
    bufp->fullQData(oldp+134,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[5]),33);
    bufp->fullQData(oldp+136,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[6]),33);
    bufp->fullQData(oldp+138,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[7]),33);
    bufp->fullQData(oldp+140,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[8]),33);
    bufp->fullQData(oldp+142,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[9]),33);
    bufp->fullQData(oldp+144,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__lut_out),33);
    bufp->fullBit(oldp+146,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__hit));
    bufp->fullBit(oldp+147,(vlSelf->rst));
    bufp->fullBit(oldp+148,(vlSelf->clk));
    bufp->fullIData(oldp+149,(vlSelf->pc),32);
    bufp->fullBit(oldp+150,(vlSelf->inv_flag));
    bufp->fullIData(oldp+151,(((IData)(4U) + vlSelf->pc)),32);
    bufp->fullBit(oldp+152,(vlSelf->ysyx_23060111_top__DOT__wen));
