...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+106,"m_wen", false,-1);
    ...
    tracep->declQuad(c+109,"default_out", false,-1, 36,0);
    ...
    tracep->declBus(c+115,"flag", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+102,(vlSelf->ysyx_23060111_top__DOT__m_waddr),32);
    bufp->fullIData(oldp+103,(vlSelf->ysyx_23060111_top__DOT__m_wdata),32);
    bufp->fullIData(oldp+104,(vlSelf->ysyx_23060111_top__DOT__m_wmask),32);
    bufp->fullIData(oldp+105,(vlSelf->ysyx_23060111_top__DOT__m_raddr),32);
    bufp->fullBit(oldp+106,(vlSelf->ysyx_23060111_top__DOT__m_wen));
    bufp->fullIData(oldp+107,(7U),32);
    bufp->fullIData(oldp+108,(0x25U),32);
    bufp->fullQData(oldp+109,(1ULL),37);
    bufp->fullIData(oldp+111,(1U),32);
    bufp->fullIData(oldp+112,(0x2cU),32);
