...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+76,"rbb", false,-1, 31,0);
    ...
    tracep->declBus(c+82,"raddr", false,-1, 4,0);
    tracep->declBit(c+86,"wen", false,-1);
    tracep->declBus(c+87,"rout", false,-1, 31,0);
    ...
    tracep->declQuad(c+91,"default_out", false,-1, 35,0);
    tracep->declArray(c+10,"lut", false,-1, 214,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+88,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+89,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+90,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+93,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declQuad(c+8,"out", false,-1, 35,0);
    tracep->declBus(c+79,"key", false,-1, 6,0);
    tracep->declQuad(c+91,"default_out", false,-1, 35,0);
    tracep->declArray(c+10,"lut", false,-1, 214,0);
    tracep->declBus(c+94,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 5; ++i) {
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+76,(vlSelf->rbb),32);
    bufp->fullIData(oldp+77,(vlSelf->ysyx_23060111_top__DOT__dnpc),32);
    ...
    bufp->fullBit(oldp+86,(vlSelf->ysyx_23060111_top__DOT__wen));
    bufp->fullIData(oldp+87,(vlSelf->ysyx_23060111_top__DOT__rout),32);
    bufp->fullIData(oldp+88,(5U),32);
    bufp->fullIData(oldp+89,(7U),32);
    bufp->fullIData(oldp+90,(0x24U),32);
    bufp->fullQData(oldp+91,(0ULL),36);
    bufp->fullIData(oldp+93,(1U),32);
    bufp->fullIData(oldp+94,(0x2bU),32);
    bufp->fullIData(oldp+95,(5U),32);
    bufp->fullIData(oldp+96,(0x20U),32);
    bufp->fullIData(oldp+97,(0x80000000U),32);
