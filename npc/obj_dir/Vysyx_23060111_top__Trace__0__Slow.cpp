...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+38,"rbb", false,-1, 31,0);
    ...
    tracep->declBus(c+45,"rs2", false,-1, 24,20);
    tracep->declBus(c+46,"funct7", false,-1, 31,25);
    tracep->declBus(c+47,"type_i", false,-1, 3,0);
    tracep->declBus(c+48,"imm", false,-1, 31,0);
    tracep->declBus(c+49,"wdata", false,-1, 31,0);
    tracep->declBus(c+50,"waddr", false,-1, 4,0);
    tracep->declBus(c+51,"raddr", false,-1, 4,0);
    ...
    tracep->declBus(c+54,"RESET_VAL", false,-1, 31,0);
    tracep->declBit(c+35,"clk", false,-1);
    tracep->declBit(c+34,"rst", false,-1);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+38,(vlSelf->rbb),32);
    bufp->fullIData(oldp+39,(((IData)(4U) + vlSelf->pc)),32);
    bufp->fullIData(oldp+40,(vlSelf->ysyx_23060111_top__DOT__dnpc),32);
    bufp->fullCData(oldp+41,(vlSelf->ysyx_23060111_top__DOT__opcode),7);
    bufp->fullCData(oldp+42,(vlSelf->ysyx_23060111_top__DOT__rd),5);
    bufp->fullCData(oldp+43,(vlSelf->ysyx_23060111_top__DOT__funct3),3);
    bufp->fullCData(oldp+44,(vlSelf->ysyx_23060111_top__DOT__rs1),5);
    bufp->fullCData(oldp+45,(vlSelf->ysyx_23060111_top__DOT__rs2),5);
    bufp->fullCData(oldp+46,(vlSelf->ysyx_23060111_top__DOT__funct7),7);
    bufp->fullCData(oldp+47,(vlSelf->ysyx_23060111_top__DOT__type_i),4);
    bufp->fullIData(oldp+48,(vlSelf->ysyx_23060111_top__DOT__imm),32);
    bufp->fullIData(oldp+49,(vlSelf->ysyx_23060111_top__DOT__wdata),32);
    bufp->fullCData(oldp+50,(vlSelf->ysyx_23060111_top__DOT__waddr),5);
    bufp->fullCData(oldp+51,(vlSelf->ysyx_23060111_top__DOT__raddr),5);
    bufp->fullBit(oldp+52,(vlSelf->ysyx_23060111_top__DOT__wen));
