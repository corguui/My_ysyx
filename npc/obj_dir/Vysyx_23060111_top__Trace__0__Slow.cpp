...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+127,"pc", false,-1, 31,0);
    tracep->declBit(c+128,"inv_flag", false,-1);
    tracep->declBus(c+21,"inst", false,-1, 31,0);
    tracep->declBus(c+11,"dnpc", false,-1, 31,0);
    tracep->declBus(c+92,"snpc", false,-1, 31,0);
    tracep->declBus(c+22,"opcode", false,-1, 6,0);
    tracep->declBus(c+23,"rd", false,-1, 11,7);
    tracep->declBus(c+24,"funct3", false,-1, 14,12);
    tracep->declBus(c+25,"rs1", false,-1, 19,15);
    tracep->declBus(c+26,"rs2", false,-1, 24,20);
    tracep->declBus(c+27,"funct7", false,-1, 31,25);
    ...
    tracep->declBus(c+87,"rout1", false,-1, 31,0);
    tracep->declBus(c+88,"rout2", false,-1, 31,0);
    tracep->declBus(c+14,"m_waddr", false,-1, 31,0);
    tracep->declBus(c+15,"m_wdata", false,-1, 31,0);
    tracep->declBus(c+16,"m_wmask", false,-1, 31,0);
    tracep->declBus(c+17,"m_rdata", false,-1, 31,0);
    tracep->declBus(c+18,"m_raddr", false,-1, 31,0);
    tracep->declBit(c+19,"m_wen", false,-1);
    tracep->declBit(c+20,"m_ren", false,-1);
    ...
    tracep->declBus(c+88,"src2", false,-1, 31,0);
    ...
    for (int i = 0; i < 10; ++i) {
        tracep->declQuad(c+44+i*2,"pair_list", true,(i+0), 39,0);
    }
    for (int i = 0; i < 10; ++i) {
        tracep->declBus(c+1+i*1,"key_list", true,(i+0), 6,0);
    }
    for (int i = 0; i < 10; ++i) {
        tracep->declQuad(c+64+i*2,"data_list", true,(i+0), 32,0);
    }
    tracep->declQuad(c+84,"lut_out", false,-1, 32,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+17,(vlSelf->ysyx_23060111_top__DOT__m_rdata),32);
    bufp->fullIData(oldp+18,(vlSelf->ysyx_23060111_top__DOT__m_raddr),32);
    bufp->fullBit(oldp+19,(vlSelf->ysyx_23060111_top__DOT__m_wen));
    bufp->fullBit(oldp+20,(vlSelf->ysyx_23060111_top__DOT__m_ren));
    bufp->fullIData(oldp+21,(vlSelf->ysyx_23060111_top__DOT__inst),32);
    bufp->fullCData(oldp+22,(vlSelf->ysyx_23060111_top__DOT__opcode),7);
    bufp->fullCData(oldp+23,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                       >> 7U))),5);
    bufp->fullCData(oldp+24,(vlSelf->ysyx_23060111_top__DOT__funct3),3);
    bufp->fullCData(oldp+25,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+26,((0x1fU & (vlSelf->ysyx_23060111_top__DOT__inst 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+27,(vlSelf->ysyx_23060111_top__DOT__funct7),7);
    bufp->fullIData(oldp+28,(vlSelf->ysyx_23060111_top__DOT__imm),32);
    bufp->fullQData(oldp+29,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellout__typeMux____pinNumber1),33);
    bufp->fullWData(oldp+31,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellinp__typeMux____pinNumber4),400);
    bufp->fullQData(oldp+44,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[0]),40);
    bufp->fullQData(oldp+46,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[1]),40);
    bufp->fullQData(oldp+48,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[2]),40);
    bufp->fullQData(oldp+50,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[3]),40);
    bufp->fullQData(oldp+52,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[4]),40);
    bufp->fullQData(oldp+54,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[5]),40);
    bufp->fullQData(oldp+56,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[6]),40);
    bufp->fullQData(oldp+58,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[7]),40);
    bufp->fullQData(oldp+60,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[8]),40);
    bufp->fullQData(oldp+62,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__pair_list[9]),40);
    bufp->fullQData(oldp+64,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[0]),33);
    bufp->fullQData(oldp+66,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[1]),33);
    bufp->fullQData(oldp+68,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[2]),33);
    bufp->fullQData(oldp+70,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[3]),33);
    bufp->fullQData(oldp+72,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[4]),33);
    bufp->fullQData(oldp+74,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[5]),33);
    bufp->fullQData(oldp+76,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[6]),33);
    bufp->fullQData(oldp+78,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[7]),33);
    bufp->fullQData(oldp+80,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[8]),33);
    bufp->fullQData(oldp+82,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__data_list[9]),33);
    bufp->fullQData(oldp+84,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__lut_out),33);
    bufp->fullBit(oldp+86,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT__typeMux__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+87,(vlSelf->ysyx_23060111_top__DOT__rout1),32);
    bufp->fullIData(oldp+88,(vlSelf->ysyx_23060111_top__DOT__rout2),32);
    ...
    bufp->fullIData(oldp+92,(vlSelf->ysyx_23060111_top__DOT__snpc),32);
