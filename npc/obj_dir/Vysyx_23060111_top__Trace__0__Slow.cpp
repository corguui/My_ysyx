...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declQuad(c+76,"rbb", false,-1, 32,0);
    ...
    tracep->declBus(c+75,"pc", false,-1, 31,0);
    tracep->declQuad(c+76,"rbb", false,-1, 32,0);
    tracep->declBus(c+78,"dnpc", false,-1, 31,0);
    tracep->declBus(c+79,"snpc", false,-1, 31,0);
    tracep->declBus(c+80,"opcode", false,-1, 6,0);
    tracep->declBus(c+81,"rd", false,-1, 11,7);
    tracep->declBus(c+82,"funct3", false,-1, 14,12);
    tracep->declBus(c+83,"rs1", false,-1, 19,15);
    tracep->declBus(c+84,"rs2", false,-1, 24,20);
    tracep->declBus(c+85,"funct7", false,-1, 31,25);
    tracep->declBus(c+6,"type_i", false,-1, 3,0);
    tracep->declBus(c+7,"imm", false,-1, 31,0);
    tracep->declBus(c+86,"wdata", false,-1, 31,0);
    tracep->declBus(c+81,"waddr", false,-1, 4,0);
    tracep->declBus(c+83,"raddr", false,-1, 4,0);
    tracep->declBit(c+87,"wen", false,-1);
    tracep->declBus(c+88,"rout", false,-1, 31,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullQData(oldp+76,(vlSelf->rbb),33);
    bufp->fullIData(oldp+78,(vlSelf->ysyx_23060111_top__DOT__dnpc),32);
    bufp->fullIData(oldp+79,(((IData)(4U) + vlSelf->pc)),32);
    bufp->fullCData(oldp+80,((0x7fU & vlSelf->inst)),7);
    bufp->fullCData(oldp+81,((0x1fU & (vlSelf->inst 
                                       >> 7U))),5);
    bufp->fullCData(oldp+82,((7U & (vlSelf->inst >> 0xcU))),3);
    ...
    bufp->fullBit(oldp+87,(vlSelf->ysyx_23060111_top__DOT__wen));
    bufp->fullIData(oldp+88,(vlSelf->ysyx_23060111_top__DOT__rout),32);
