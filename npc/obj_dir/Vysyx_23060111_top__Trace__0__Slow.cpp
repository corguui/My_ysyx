...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+87,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+88,"DATA_LEN", false,-1, 31,0);
    tracep->declQuad(c+8,"out", false,-1, 35,0);
    tracep->declBus(c+77,"key", false,-1, 6,0);
    tracep->declQuad(c+89,"default_out", false,-1, 35,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+6,((0xfU & (IData)((vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellout__typeMux____pinNumber1 
                                             >> 0x20U)))),4);
    bufp->fullIData(oldp+7,((IData)(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellout__typeMux____pinNumber1)),32);
    bufp->fullQData(oldp+8,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellout__typeMux____pinNumber1),36);
    bufp->fullWData(oldp+10,(vlSelf->ysyx_23060111_top__DOT__init_IDU__DOT____Vcellinp__typeMux____pinNumber4),215);
    ...
    bufp->fullIData(oldp+88,(0x24U),32);
    bufp->fullQData(oldp+89,(0ULL),36);
    bufp->fullIData(oldp+91,(1U),32);
    bufp->fullIData(oldp+92,(0x2bU),32);
