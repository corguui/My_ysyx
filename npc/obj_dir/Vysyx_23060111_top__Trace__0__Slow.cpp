...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+116,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+117,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+119,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declBus(c+45,"out", false,-1, 31,0);
    tracep->declBus(c+11,"key", false,-1, 3,0);
    tracep->declBus(c+118,"default_out", false,-1, 31,0);
    tracep->declArray(c+107,"lut", false,-1, 179,0);
    ...
    tracep->declQuad(c+123,"default_out", false,-1, 35,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+45,(vlSelf->ysyx_23060111_top__DOT__wdata),32);
    ...
    bufp->fullIData(oldp+113,(vlSelf->ysyx_23060111_top__DOT__dnpc),32);
    ...
    bufp->fullIData(oldp+120,(0x24U),32);
    bufp->fullIData(oldp+121,(5U),32);
    bufp->fullIData(oldp+122,(7U),32);
    bufp->fullQData(oldp+123,(0ULL),36);
    bufp->fullIData(oldp+125,(0x2bU),32);
