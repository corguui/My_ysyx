...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+39,"rd", false,-1, 11,7);
    tracep->declBus(c+40,"funct3", false,-1, 14,12);
    tracep->declBus(c+41,"rs1", false,-1, 19,15);
    tracep->declBus(c+42,"rs2", false,-1, 24,20);
    tracep->declBus(c+43,"funct7", false,-1, 31,25);
    tracep->declBus(c+45,"type_i", false,-1, 3,0);
    ...
    tracep->declBus(c+44,"rout", false,-1, 31,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+42,((0x1fU & (vlSelf->inst 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+43,((vlSelf->inst >> 0x19U)),7);
    bufp->fullIData(oldp+44,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf
                             [(0x1fU & (vlSelf->inst 
                                        >> 0xfU))]),32);
    bufp->fullCData(oldp+45,(vlSelf->ysyx_23060111_top__DOT__type_i),4);
    bufp->fullIData(oldp+46,(vlSelf->ysyx_23060111_top__DOT__imm),32);
    bufp->fullIData(oldp+47,(vlSelf->ysyx_23060111_top__DOT__wdata),32);
