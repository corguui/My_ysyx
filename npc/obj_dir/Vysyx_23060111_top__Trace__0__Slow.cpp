...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+36,"snpc", false,-1, 31,0);
    tracep->declBus(c+37,"dnpc", false,-1, 31,0);
    ...
    tracep->declBus(c+39,"rbb", false,-1, 9,0);
    tracep->declBit(c+49,"wen", false,-1);
    tracep->declBit(c+47,"nclk", false,-1);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+36,(vlSelf->snpc),32);
    bufp->fullIData(oldp+37,(vlSelf->dnpc),32);
    bufp->fullIData(oldp+38,(vlSelf->pc),32);
    bufp->fullSData(oldp+39,(vlSelf->rbb),10);
    bufp->fullSData(oldp+40,((vlSelf->inst >> 0x14U)),12);
    ...
    bufp->fullIData(oldp+46,(vlSelf->ysyx_23060111_top__DOT__reg___0240__DOT__rf
                             [(0x1fU & (vlSelf->inst 
                                        >> 0xfU))]),32);
    bufp->fullBit(oldp+47,((1U & (~ (IData)(vlSelf->clk)))));
    ...
    bufp->fullIData(oldp+52,(0x80000008U),32);
