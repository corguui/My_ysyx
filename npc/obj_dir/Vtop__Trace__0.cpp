...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+17,(((3U == (IData)(vlSelf->top__DOT__IDU__DOT__exu_data_inst_type))
        ...
        bufp->chgBit(oldp+54,(vlSelf->top__DOT__IFU__DOT__rready_reg));
        ...
        bufp->chgBit(oldp+75,(vlSelf->top__DOT__IFU__DOT__m2EXUstate));
        bufp->chgIData(oldp+76,(vlSelf->top__DOT__IFU__DOT__ardata_reg),32);
        bufp->chgBit(oldp+77,(vlSelf->top__DOT__IFU__DOT__delay_arvalid_REG));
        bufp->chgBit(oldp+78,(vlSelf->top__DOT__IFU__DOT__delay_arvalid));
        bufp->chgIData(oldp+79,(vlSelf->top__DOT__IFU__DOT__io_out_bits_pc_REG),32);
        bufp->chgBit(oldp+80,(vlSelf->top__DOT__IFU__DOT__arvalid_en));
        bufp->chgIData(oldp+81,(vlSelf->top__DOT__Inst_fetch__DOT__rdata_reg),32);
        bufp->chgCData(oldp+82,(vlSelf->top__DOT__Inst_fetch__DOT__rresp_reg),2);
        bufp->chgIData(oldp+83,(((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg)
                                  ? ((IData)(vlSelf->top__DOT__IFU__DOT____VdfgTmp_haf7782c8__0)
                                      ? vlSelf->top__DOT__IFU__DOT__ardata_reg
                                      : 0U) : 0U)),32);
        bufp->chgIData(oldp+84,(vlSelf->top__DOT__Inst_fetch__DOT___vlg_pc_read_inst),32);
        bufp->chgIData(oldp+85,(vlSelf->top__DOT__Mem__DOT__rdata_reg),32);
        bufp->chgCData(oldp+86,(vlSelf->top__DOT__Mem__DOT__rresp_reg),2);
        bufp->chgCData(oldp+87,(vlSelf->top__DOT__Mem__DOT__bresp_reg),2);
        ...
        bufp->chgBit(oldp+94,(vlSelf->top__DOT__Mem__DOT__m__DOT__m_wready));
    ...
    bufp->chgIData(oldp+133,((((IData)(vlSelf->top__DOT__IFU__DOT__m2EXUstate) 
