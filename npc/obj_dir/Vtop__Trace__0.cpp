...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgIData(oldp+62,(vlSelf->top__DOT__Mem__DOT__m_rdata_delay_r),32);
        bufp->chgIData(oldp+63,(vlSelf->top__DOT__Mem__DOT__m_rdata_delay_r_1),32);
        bufp->chgIData(oldp+64,(vlSelf->top__DOT__Mem__DOT__m_rdata_delay_r_2),32);
        bufp->chgIData(oldp+65,(vlSelf->top__DOT__Mem__DOT__m_rdata_delay_r_3),32);
        bufp->chgIData(oldp+66,(vlSelf->top__DOT__Mem__DOT__m_rdata_delay),32);
        bufp->chgIData(oldp+67,(vlSelf->top__DOT__Mem__DOT__rdata_reg),32);
        bufp->chgCData(oldp+68,(vlSelf->top__DOT__Mem__DOT__rresp_reg),2);
        ...
        bufp->chgBit(oldp+72,(vlSelf->top__DOT__Mem__DOT__rvalid_en));
        ...
        bufp->chgBit(oldp+80,(vlSelf->top__DOT__Mem__DOT__m__DOT__m_wready));
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgBit(oldp+116,(vlSelf->top__DOT__IFU__DOT__rready_reg));
        bufp->chgIData(oldp+117,(vlSelf->top__DOT__IFU__DOT__inst_reg),32);
        bufp->chgCData(oldp+118,((0x1fU & (vlSelf->top__DOT__IFU__DOT__inst_reg 
                                           >> 0xfU))),5);
        bufp->chgIData(oldp+119,(vlSelf->top__DOT__Reg__DOT__casez_tmp),32);
        bufp->chgCData(oldp+120,((0x1fU & (vlSelf->top__DOT__IFU__DOT__inst_reg 
                                           >> 0x14U))),5);
        bufp->chgIData(oldp+121,(vlSelf->top__DOT__Reg__DOT__casez_tmp_0),32);
        bufp->chgCData(oldp+122,(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr),2);
        bufp->chgIData(oldp+123,(vlSelf->top__DOT__IDU__DOT__csr_imm),32);
        bufp->chgCData(oldp+124,(vlSelf->top__DOT__IDU__DOT__casez_tmp),5);
        bufp->chgCData(oldp+125,(vlSelf->top__DOT__IDU__DOT__casez_tmp_0),5);
        bufp->chgBit(oldp+126,(vlSelf->top__DOT__IFU__DOT__arvalid_reg));
        bufp->chgIData(oldp+127,(((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg)
                                   ? vlSelf->top__DOT__Inst_fetch__DOT__rdata_reg
                                   : 0U)),32);
        bufp->chgBit(oldp+128,(vlSelf->top__DOT__Inst_fetch__DOT__rvalid_reg));
        bufp->chgBit(oldp+129,(vlSelf->top__DOT__IFU__DOT__m2EXUstate));
        bufp->chgIData(oldp+130,(vlSelf->top__DOT__Inst_fetch__DOT__rdata_reg),32);
    }
    bufp->chgBit(oldp+131,(vlSelf->clock));
    bufp->chgBit(oldp+132,(vlSelf->reset));
    bufp->chgIData(oldp+133,(vlSelf->io_pc),32);
    bufp->chgBit(oldp+134,(vlSelf->io_inv_flag));
    bufp->chgIData(oldp+135,(((IData)(4U) + vlSelf->io_pc)),32);
    bufp->chgIData(oldp+136,(((0U == (IData)(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr))
    ...
    bufp->chgIData(oldp+137,((((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg) 
