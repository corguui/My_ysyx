...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+18,(vlSelf->top__DOT__EXU__DOT__mem_wen_reg));
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgCData(oldp+64,(((IData)(vlSelf->top__DOT__EXU__DOT___GEN_10)
                                  ? 0U : (7U & vlSelf->top__DOT__IDU__DOT__exu_data_m_wmask))),3);
        bufp->chgBit(oldp+65,(((IData)(vlSelf->top__DOT__EXU__DOT__memwen_reg_en) 
                               & (IData)(vlSelf->top__DOT__EXU__DOT__mem_wen_reg))));
        bufp->chgBit(oldp+66,(((IData)(vlSelf->top__DOT__Mem__DOT___GEN_1) 
                               & (IData)(vlSelf->top__DOT__Mem__DOT___m_m_wready))));
                                   ...
                                   : ((3U == (IData)(vlSelf->top__DOT__IDU__DOT__exu_data_inst_type))
                                       ...
                                       : ((~ (IData)(vlSelf->top__DOT__EXU__DOT___GEN_20)) 
                                          & ((IData)(vlSelf->top__DOT__EXU__DOT___GEN_21) 
                                             & (IData)(vlSelf->top__DOT__IDU__DOT__exu_data_reg_wen))))))));
        bufp->chgIData(oldp+68,(((1U & ((~ (IData)(vlSelf->top__DOT__EXU__DOT__m2IDUstate)) 
        ...
        bufp->chgIData(oldp+69,(((0U == (IData)(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr))
        ...
        bufp->chgIData(oldp+70,(((((IData)(vlSelf->top__DOT__EXU__DOT__memwen_reg_en) 
                                   & (IData)(vlSelf->top__DOT__EXU__DOT__mem_wen_reg)) 
                                  & (vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr 
                                     != vlSelf->top__DOT__Mem__DOT__lastawaddr))
                                  ? vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr
                                  : 0U)),32);
        bufp->chgIData(oldp+71,(((IData)(vlSelf->top__DOT__Mem__DOT___GEN_1)
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+73,(vlSelf->top__DOT__EXU__DOT__ifu_outdata_dnpc),32);
        bufp->chgIData(oldp+74,(vlSelf->top__DOT___EXU_io_ar_exu_mem_raddr),32);
        bufp->chgCData(oldp+75,(vlSelf->top__DOT___EXU_io_ar_exu_mem_rmask),3);
        bufp->chgBit(oldp+76,(vlSelf->top__DOT___EXU_io_ar_exu_mem_arvalid));
        ...
        bufp->chgIData(oldp+78,(((IData)(vlSelf->top__DOT__Mem__DOT__io_r_mem_exu_rvalid_0)
                                  ...
                                  : 0U)),32);
        bufp->chgCData(oldp+79,((((IData)(vlSelf->top__DOT__Mem__DOT__io_r_mem_exu_rvalid_0) 
                                  ...
                                  : 0U)),2);
        bufp->chgIData(oldp+80,(vlSelf->top__DOT___EXU_io_w_exu_mem_wdata),32);
        bufp->chgBit(oldp+81,(vlSelf->top__DOT___EXU_io_w_exu_mem_wvalid));
        bufp->chgIData(oldp+82,(vlSelf->top__DOT___EXU_io_aw_exu_mem_awaddr),32);
        bufp->chgIData(oldp+83,(vlSelf->top__DOT___EXU_io_reg_wdata),32);
        bufp->chgCData(oldp+84,(vlSelf->top__DOT___EXU_io_reg_waddr),5);
        bufp->chgCData(oldp+85,(vlSelf->top__DOT___EXU_io_csr_waddr_1),2);
        bufp->chgIData(oldp+86,(vlSelf->top__DOT___EXU_io_csr_wdata_1),32);
        bufp->chgBit(oldp+87,(vlSelf->top__DOT___EXU_io_csr_wen_1));
        bufp->chgBit(oldp+88,(((IData)(vlSelf->top__DOT__EXU__DOT__m2IDUstate) 
                               & ((~ (IData)(vlSelf->top__DOT__EXU__DOT___GEN_26)) 
                                  & (0xcU == (IData)(vlSelf->top__DOT__IDU__DOT__exu_data_inst_type))))));
        bufp->chgBit(oldp+89,(vlSelf->top__DOT__EXU__DOT__memwen_reg_en));
        bufp->chgBit(oldp+90,(vlSelf->top__DOT__EXU__DOT__m2IDUstate));
        ...
        bufp->chgIData(oldp+110,(((IData)(vlSelf->top__DOT__Mem__DOT___GEN_1)
                                   ? vlSelf->top__DOT___EXU_io_w_exu_mem_wdata
                                   : 0U)),32);
        bufp->chgBit(oldp+111,(((IData)(vlSelf->top__DOT__Mem__DOT___GEN_1) 
                                & (IData)(vlSelf->top__DOT___EXU_io_w_exu_mem_wvalid))));
        bufp->chgIData(oldp+112,(vlSelf->top__DOT__Mem__DOT___GEN),32);
        bufp->chgIData(oldp+113,(((IData)(vlSelf->top__DOT__Mem__DOT__io_r_mem_exu_rvalid_0)
                                   ? (IData)(vlSelf->top__DOT___EXU_io_ar_exu_mem_rmask)
                                   : 0U)),32);
        bufp->chgBit(oldp+114,(((IData)(vlSelf->top__DOT__Mem__DOT__io_r_mem_exu_rvalid_0) 
