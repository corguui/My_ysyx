...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+255,(vlSelf->top__DOT__IFU__DOT__inst_reg),32);
        bufp->chgCData(oldp+256,((0x1fU & (vlSelf->top__DOT__IFU__DOT__inst_reg 
                                           >> 0xfU))),5);
        bufp->chgIData(oldp+257,(vlSelf->top__DOT__Reg__DOT__casez_tmp),32);
        bufp->chgCData(oldp+258,((0x1fU & (vlSelf->top__DOT__IFU__DOT__inst_reg 
                                           >> 0x14U))),5);
        bufp->chgIData(oldp+259,(vlSelf->top__DOT__Reg__DOT__casez_tmp_0),32);
        bufp->chgCData(oldp+260,(vlSelf->top__DOT___IDU_io_reg_data_csr_raddr),2);
        bufp->chgIData(oldp+261,(vlSelf->top__DOT__IDU__DOT__csr_imm),32);
        bufp->chgCData(oldp+262,(vlSelf->top__DOT__IDU__DOT__casez_tmp),5);
        bufp->chgCData(oldp+263,(vlSelf->top__DOT__IDU__DOT__casez_tmp_0),5);
        bufp->chgBit(oldp+264,(vlSelf->top__DOT___WBU_io_out2ifu_valid));
        bufp->chgBit(oldp+265,(vlSelf->top__DOT__IFU__DOT__m2EXUstate));
        bufp->chgIData(oldp+266,(vlSelf->top__DOT__LSU__DOT___GEN_3),32);
        bufp->chgIData(oldp+267,(vlSelf->top__DOT__RTC__DOT__rtc_raddr),32);
        bufp->chgBit(oldp+268,(vlSelf->top__DOT__RTC__DOT__rvalid_en));
        bufp->chgBit(oldp+269,(vlSelf->top__DOT__SRAM__DOT__rvalid_en));
        bufp->chgBit(oldp+270,(vlSelf->top__DOT__SRAM__DOT__bvalid_en));
        bufp->chgIData(oldp+271,(((IData)(vlSelf->top__DOT___AXI_arbiter_io_axi_ar_arvalid)
                                   ? vlSelf->top__DOT__SRAM__DOT___m_m_rdata
                                   : 0U)),32);
        bufp->chgIData(oldp+272,(vlSelf->top__DOT__SRAM__DOT___GEN_1),32);
        bufp->chgIData(oldp+273,(((IData)(vlSelf->top__DOT___AXI_arbiter_io_axi_aw_awvalid)
                                   ? vlSelf->top__DOT___AXI_arbiter_io_axi_aw_awaddr
                                   : 0U)),32);
        bufp->chgIData(oldp+274,(((IData)(vlSelf->top__DOT___AXI_arbiter_io_axi_w_wvalid)
                                   ? (IData)(vlSelf->top__DOT___AXI_arbiter_io_axi_w_wstrb)
                                   : 0U)),32);
        bufp->chgIData(oldp+275,(vlSelf->top__DOT__SRAM__DOT___GEN),32);
        bufp->chgIData(oldp+276,(((IData)(vlSelf->top__DOT___AXI_arbiter_io_axi_ar_arvalid) 
                                  << 2U)),32);
        bufp->chgIData(oldp+277,(vlSelf->top__DOT__SRAM__DOT___m_m_rdata),32);
        bufp->chgBit(oldp+278,(vlSelf->top__DOT__UART__DOT__bvalid_en));
        bufp->chgIData(oldp+279,(vlSelf->top__DOT__UART__DOT___GEN),32);
        bufp->chgIData(oldp+280,(((IData)(vlSelf->top__DOT___AXI_arbiter_io_uart_axi_aw_awvalid)
                                   ? vlSelf->top__DOT___AXI_arbiter_io_uart_axi_aw_awaddr
                                   : 0U)),32);
        bufp->chgIData(oldp+281,(((IData)(vlSelf->top__DOT___AXI_arbiter_io_uart_axi_w_wvalid)
                                   ? (IData)(vlSelf->top__DOT___AXI_arbiter_io_uart_axi_w_wstrb)
                                   : 0U)),32);
    }
    bufp->chgBit(oldp+282,(vlSelf->clock));
    bufp->chgBit(oldp+283,(vlSelf->reset));
    bufp->chgIData(oldp+284,(vlSelf->io_pc),32);
    bufp->chgBit(oldp+285,(vlSelf->io_inv_flag));
    bufp->chgIData(oldp+286,(((IData)(4U) + vlSelf->io_pc)),32);
}
