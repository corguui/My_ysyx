...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+78,(vlSelf->top__DOT__IFU__DOT__arvalid_en));
        bufp->chgIData(oldp+79,(vlSelf->top__DOT__Inst_fetch__DOT__rdata_reg),32);
        bufp->chgCData(oldp+80,(vlSelf->top__DOT__Inst_fetch__DOT__rresp_reg),2);
        bufp->chgIData(oldp+81,(((IData)(vlSelf->top__DOT__IFU__DOT__arvalid_reg)
                                  ? ((IData)(vlSelf->top__DOT__IFU__DOT____VdfgTmp_haf7782c8__0)
                                      ? vlSelf->top__DOT__IFU__DOT__ardata_reg
                                      : 0U) : 0U)),32);
        bufp->chgIData(oldp+82,(vlSelf->top__DOT__Inst_fetch__DOT___vlg_pc_read_inst),32);
        bufp->chgIData(oldp+83,(vlSelf->top__DOT__Mem__DOT__rdata_reg),32);
        bufp->chgCData(oldp+84,(vlSelf->top__DOT__Mem__DOT__rresp_reg),2);
        bufp->chgCData(oldp+85,(vlSelf->top__DOT__Mem__DOT__bresp_reg),2);
        ...
        bufp->chgBit(oldp+92,(vlSelf->top__DOT__Mem__DOT__m__DOT__m_wready));
    ...
    bufp->chgIData(oldp+129,(vlSelf->io_pc),32);
    bufp->chgBit(oldp+130,(vlSelf->io_inv_flag));
    bufp->chgIData(oldp+131,(((IData)(vlSelf->top__DOT__IFU__DOT____VdfgTmp_h5e3af682__0)
