...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgIData(oldp+77,(vlSelf->top__DOT__IFU__DOT__io_out_bits_pc_REG),32);
        bufp->chgIData(oldp+78,(vlSelf->top__DOT__Inst_fetch__DOT__rdata_reg),32);
        bufp->chgCData(oldp+79,(vlSelf->top__DOT__Inst_fetch__DOT__rresp_reg),2);
    ...
    bufp->chgIData(oldp+130,(((IData)(vlSelf->top__DOT__IFU__DOT____VdfgTmp_h5e3af682__0)
