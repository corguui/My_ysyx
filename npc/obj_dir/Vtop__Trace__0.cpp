...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+29,(vlSelf->top__DOT__Mem__DOT__bresp_reg),2);
        ...
        bufp->chgIData(oldp+57,(vlSelf->top__DOT__IFU__DOT__indata_dnpc),32);
        bufp->chgIData(oldp+58,(vlSelf->top__DOT__IFU__DOT__ardata_reg),32);
        bufp->chgIData(oldp+59,(vlSelf->top__DOT__IFU__DOT__io_out_bits_pc_REG),32);
