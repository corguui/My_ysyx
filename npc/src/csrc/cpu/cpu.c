...
void cpu_read_reg()
{
	cpu.pc=top->top__DOT__IFU__DOT__io_out_bits_pc_0;
...
void cpu_write_reg()
{
	top->top__DOT__IFU__DOT__io_out_bits_pc_0=cpu.pc;
...
void cpu_exec_once(VerilatedVcdC* tfp,Decode *s)
{
		...
		top->clock =0; top->eval();
		valid_flag=0;
		if(top->top__DOT__IFU__DOT__io_out_bits_pc_0!=0&&top->rootp->top__DOT__WBU__DOT__ifu_outdata_dnpc!=0x80000000&&cmp_dnpc!=top->rootp->top__DOT__WBU__DOT__ifu_outdata_dnpc)
		{
		valid_flag =1;
		pc=top->top__DOT__IFU__DOT__io_out_bits_pc_0;
		s->pc=top->top__DOT__IFU__DOT__io_out_bits_pc_0;
		...
		cmp_dnpc=top->rootp->top__DOT__WBU__DOT__ifu_outdata_dnpc;
		#ifdef CONFIG_VCD
		tfp->dump(main_time);
		#endif
		main_time++;
     ...
     case NPC_END: case NPC_ABORT:
      ...
      Log("npc: %s at pc = 0x%x",
          (npc_state.state == NPC_ABORT ? ANSI_FMT("ABORT", ANSI_FG_RED) :
           (npc_state.halt_ret == 0 ? ANSI_FMT("HIT GOOD TRAP", ANSI_FG_GREEN) :  ANSI_FMT("HIT BAD TRAP", ANSI_FG_RED))), top->top__DOT__IFU__DOT__io_out_bits_pc_0);
