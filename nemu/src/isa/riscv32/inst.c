...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd)=(uint64_t)src1*(uint64_t)src2 >> 32 ;printf("R(rd) == %x\n",R(rd)) );
  //INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh    , R, R(rd)= ((SEXT(src1,32)*SEXT(src2,32)) >> 32) ; printf("R(rd) == %x\n",R(rd)) );
