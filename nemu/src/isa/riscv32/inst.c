...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  //INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh    , R,printf("src1==%x   src2==%x \n",src1,src2 ); R(rd)=(word_t)((int32_t)src1*(int32_t)src2) >> 8 );
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh    , R, printf("src1==%ld src2==%ld\n",SEXT(src1,32),SEXT(src2,32)); R(rd)= ((SEXT(src1,32)*SEXT(src2,32)) >> 32) );
